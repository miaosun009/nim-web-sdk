	...
	return (function(e) {
		...
		function(e, t, n) {
			...
			(l.deduplicate = function(e) {
				...
				(l.mergeObjArray = function() {
					...
					return (
						...
						n.notSort || (e = l.sortObjArray(e, n)),
						e
					);
				}),
				...
				(l.onParamInvalidType = function(e, t, n, r) {
					(n = n || ''),
						(t = l.isArray(t)
							...
							: '"' + t + '"'),
						l.onParamError('参数"' + n + e + '"类型错误, 合法的类型包括: [' + t + ']', r);
				}),
				...
				(l.onParamInvalidValue = function(e, t, n) {
					l.isArray(t) || (t = [t]),
						...
						l.isArray(t) && (t = t.join(', ')),
						l.onParamError('参数 ' + e + '值错误, 合法的值包括: [' + JSON.stringify(t) + ']', n);
				}),
				...
				(l.verifyParamPresentJustOne = function(e, t, n) {
					t &&
						...
						l.isArray(t) &&
							...
							l.onParamError('以下参数[' + t.join(', ') + ']必须且只能传入一个', n));
				}),
				(l.verifyBooleanWithDefault = function(e, t, n, r, s) {
					l.undef(n) && (n = !0),
						...
						l.isArray(t)
							...
							: void 0 === e[t]
							? (e[t] = n)
							: l.isBoolean(e[t]) || l.onParamInvalidType(t, 'boolean', r, s);
				}),
				...
				(l.verifyCallback = function(e, t, n) {
					d.test(t) && (t = t.split(d)),
						l.isArray(t)
							...
							: e[t]
							? l.isFunction(e[t]) || l.onParamInvalidType(t, 'function', '', n)
							: (e[t] = l.emptyFunc);
				}),
				...
				(l.validFileExts = { image: ['bmp', 'gif', 'jpg', 'jpeg', 'jng', 'png', 'webp'], audio: ['mp3', 'wav', 'aac', 'wma', 'wmv', 'amr', 'mp2', 'flac', 'vorbis', 'ac3'], video: ['mp4', 'rm', 'rmvb', 'wmv', 'avi', 'mpg', 'mpeg'] }),
			...
			(l.getFileName = function(e) {
				...
				(l.getFileInfo = ((p = { ppt: 1, pptx: 2, pdf: 3 }),
				function(e) {
					var t = {};
				...
				(l.sizeText = ((f = ['B', 'KB', 'MB', 'GB', 'TB', 'PB', 'EB', 'ZB', 'BB']),
				function(e) {
					var t,
						n = 0;
					do {
		...
		function(e, t, n) {
			'use strict';
			var r = {
				info: { hash: '1eb7eaefc2ae42b41a38b757b8d0a730c46e5067', shortHash: '1eb7eaef', version: '6.3.0', sdkVersion: '52', nrtcVersion: '4.5.0', nrtcSdkVersion: '1', protocolVersion: 1 },
			...
			(r.weixinNetcall = r.nrtcNetcall = { checkSumUrl: 'https://nrtc.netease.im/demo/getChecksum.action', getChannelInfoUrl: 'https://nrtc.netease.im/nrtc/getChannelInfos.action' }),
		...
		function(e, t, n) {
			...
			(function(e) {
				...
				(h = { yyyy: c, MM: u, dd: l, hh: m, mm: d, ss: p, SSS: f }),
				function(e, t) {
					return (
						(e = new Date(e)),
						isNaN(+e)
						...
						((l = !d && M && void 0 !== M[u]) && a(v, u)) ||
							...
							(v[u] =
								p && 'function' != typeof M[u]
									...
									? i(Function.call, m)
									: m),
							g && (((v.virtual || (v.virtual = {}))[u] = m), e & c.R && b && !b[u] && o(b, u, m)));
				};
				...
				var o = (function() {
					...
					return (function t(n) {
						...
						var h,
							...
							D = p([{ label: 'EdgeHTML', pattern: 'Edge' }, 'Trident', { label: 'WebKit', pattern: 'AppleWebKit' }, 'iCab', 'Presto', 'NetFront', 'Tasman', 'KHTML', 'Gecko'], function(e, t) {
								...
								return p(e, function(e, t) {
									...
									return (
										!e &&
											...
											(e = (function(e, t, n) {
												var r = { '10.0': '10', 6.4: '10 Technical Preview', 6.3: '8.1', 6.2: '8', 6.1: 'Server 2008 R2 / 7', '6.0': 'Server 2008 / Vista', 5.2: 'Server 2003 / XP 64-bit', 5.1: 'XP', 5.01: '2000 SP1', '5.0': '2000', '4.0': 'NT', '4.90': 'ME' };
												return (
						...
						function W(e) {
							return p(e, function(e, t) {
								...
								return (
									!e &&
										(e = RegExp('\\b' + r + ' *\\d+[.\\w_]*', 'i').exec(n) || RegExp('\\b' + r + ' *\\w+-[\\w]*', 'i').exec(n) || RegExp('\\b' + r + '(?:; *(?:[a-z]+[_-])?[a-z]+\\d+|[^ ();-]*)', 'i').exec(n)) &&
						...
						if (
							...
							'Opera Mini' == L && /\bOPiOS\b/.test(n) && U.push('running in Turbo/Uncompressed mode'),
							'IE' == L && /\blike iPhone OS\b/.test(n)
								? ((q = (h = t(n.replace(/like iPhone OS/, ''))).manufacturer), (B = h.product))
								: /^iP/.test(B)
								? (L || (L = 'Safari'), (H = 'iOS' + ((h = / OS ([\d_]+)/i.exec(n)) ? ' ' + h[1].replace(/_/g, '.') : '')))
								: 'Konqueror' != L || /buntu/i.test(H)
								? (q && 'Google' != q && ((/Chrome/.test(L) && !/\bMobile Safari\b/i.test(n)) || /\bVita\b/.test(B))) || (/\bAndroid\b/.test(H) && /^Chrome/.test(L) && /\bVersion\//i.test(n))
									? ((L = 'Android Browser'), (H = /\bAndroid\b/.test(H) ? H : 'Android'))
									: 'Silk' == L
									? (/\bMobi/i.test(n) || ((H = 'Android'), U.unshift('desktop mode')), /Accelerated *= *true/i.test(n) && U.unshift('accelerated'))
									: 'PaleMoon' == L && (h = /\bFirefox\/([\d.]+)\b/.exec(n))
									? U.push('identifying as Firefox ' + h[1])
									: 'Firefox' == L && (h = /\b(Mobile|Tablet|TV)\b/i.exec(n))
									? (H || (H = 'Firefox OS'), B || (B = h[1]))
									: !L || (h = !/\bMinefield\b/i.test(n) && /\b(?:Firefox|Safari)\b/.exec(L))
									? (L && !B && /[\/,]|^[^(]+?\)/.test(n.slice(n.indexOf(h + '/') + 8)) && (L = null), (h = B || q || H) && (B || q || /\b(?:Android|Symbian OS|Tablet OS|webOS)\b/.test(H)) && (L = /[a-z]+(?: Hat)?/i.exec(/\bAndroid\b/.test(H) ? H : h) + ' Browser'))
									: 'Electron' == L && (h = (/\bChrome\/([\d.]+)\b/.exec(n) || 0)[1]) && U.push('Chromium ' + h)
								: (H = 'Kubuntu'),
							F ||
								(F = p(['(?:Cloud9|CriOS|CrMo|Edge|FxiOS|IEMobile|Iron|Opera ?Mini|OPiOS|OPR|Raven|SamsungBrowser|Silk(?!/[\\d.]+$))', 'Version', d(L), '(?:Firefox|Minefield|NetFront)'], function(e, t) {
							...
							'IE' == L && (h = (/; *(?:XBLWP|ZuneWP)(\d+)/i.exec(n) || 0)[1]) ? ((L += ' Mobile'), (H = 'Windows Phone ' + (/\+$/.test(h) ? h : h + '.x')), U.unshift('desktop mode')) : /\bWPDesktop\b/i.test(n) ? ((L = 'IE Mobile'), (H = 'Windows Phone 8.x'), U.unshift('desktop mode'), F || (F = (/\brv:([\d.]+)/.exec(n) || 0)[1])) : 'IE' != L && 'Trident' == D && (h = /\brv:([\d.]+)/.exec(n)) && (L && U.push('identifying as ' + L + (F ? ' ' + F : '')), (L = 'IE'), (F = h[1])),
							N)
						) {
							if (((b = 'global'), (M = null != (v = s) ? (0, i.default)(v[b]) : 'number'), /^(?:boolean|number|string|undefined)$/.test(M) || ('object' == M && !v[b])))
								m((h = s.runtime)) == S
									? ((L = 'Adobe AIR'), (H = h.flash.system.Capabilities.os))
									: m((h = s.phantom)) == P
									? ((L = 'PhantomJS'), (F = (h = h.version || null) && h.major + '.' + h.minor + '.' + h.patch))
									: 'number' == typeof A.documentMode && (h = /\bTrident\/(\d+)/i.exec(n))
									? ((F = [F, A.documentMode]), (h = +h[1] + 4) != F[1] && (U.push('IE ' + F[1] + ' mode'), D && (D[1] = ''), (F[1] = h)), (F = 'IE' == L ? String(F[1].toFixed(1)) : F[0]))
									: 'number' == typeof A.documentMode && /^(?:Chrome|Firefox)\b/.test(L) && (U.push('masking as ' + L + ' ' + F), (L = 'IE'), (F = '11.0'), (D = ['Trident']), (H = 'Windows'));
							else if ((I && ((R = (h = I.lang.System).getProperty('os.arch')), (H = H || h.getProperty('os.name') + ' ' + h.getProperty('os.version'))), O)) {
								try {
						...
						if ((F && (h = /(?:[ab]|dp|pre|[ab]\d+pre)(?:\d+\+?)?$/i.exec(F) || /(?:alpha|beta)(?: ?\d)?/i.exec(n + ';' + (N && c.appMinorVersion)) || (/\bMinefield\b/i.test(n) && 'a')) && ((j = /b/i.test(h) ? 'beta' : 'alpha'), (F = F.replace(RegExp(h + '\\+?$'), '') + ('beta' == j ? w : x) + (/\d+\+?/.exec(h) || ''))), 'Fennec' == L || ('Firefox' == L && /\b(?:Android|Firefox OS)\b/.test(H)))) L = 'Firefox Mobile';
							...
							if ('IE' == L && N)
								...
								(/\bBlackBerry\b/.test(B) || /\bBB10\b/.test(n)) && (h = (RegExp(B.replace(/ +/g, ' *') + '/([.\\d]+)', 'i').exec(n) || 0)[1] || F)
									? ((H = ((h = [h, /BB10/.test(n)])[1] ? ((B = null), (q = 'BlackBerry')) : 'Device Software') + ' ' + h[0]), (F = null))
									: this != l &&
									  'Wii' != B &&
									  ((N && _) || (/Opera/.test(L) && /\b(?:MSIE|Firefox)\b/i.test(n)) || ('Firefox' == L && /\bOS X (?:\d+\.){2,}/.test(H)) || ('IE' == L && ((H && !/^Win/.test(H) && F > 5.5) || (/\bWindows XP\b/.test(H) && F > 8) || (8 == F && !/\bTrident\b/.test(n))))) &&
									  !r.test((h = t.call(l, n.replace(r, '') + ';'))) &&
									  h.name &&
									  ((h = 'ing as ' + h.name + ((h = h.version) ? ' ' + h : '')), r.test(L) ? (/\bIE\b/.test(h) && 'Mac OS' == H && (H = null), (h = 'identify' + h)) : ((h = 'mask' + h), (L = E ? u(E.replace(/([a-z])([A-Z])/g, '$1 $2')) : 'Opera'), /\bIE\b/.test(h) && (H = null), N || (F = null)), (D = ['Presto']), U.push(h));
						else L += ' Mobile';
						(h = (/\bAppleWebKit\/([\d.]+\+?)/i.exec(n) || 0)[1]) &&
							((h = [parseFloat(h.replace(/\.(\d)$/, '.0$1')), h]),
							'Safari' == L && '+' == h[1].slice(-1) ? ((L = 'WebKit Nightly'), (j = 'alpha'), (F = h[1].slice(0, -1))) : (F != h[1] && F != (h[2] = (/\bSafari\/([\d.]+\+?)/i.exec(n) || 0)[1])) || (F = null),
							(h[1] = (/\bChrome\/([\d.]+)/i.exec(n) || 0)[1]),
							537.36 == h[0] && 537.36 == h[2] && parseFloat(h[1]) >= 28 && 'WebKit' == D && (D = ['Blink']),
							N && (T || h[1])
								? (D && (D[1] = 'like Chrome'),
								  (h = h[1] || ((h = h[0]) < 530 ? 1 : h < 532 ? 2 : h < 532.05 ? 3 : h < 533 ? 4 : h < 534.03 ? 5 : h < 534.07 ? 6 : h < 534.1 ? 7 : h < 534.13 ? 8 : h < 534.16 ? 9 : h < 534.24 ? 10 : h < 534.3 ? 11 : h < 535.01 ? 12 : h < 535.02 ? '13+' : h < 535.07 ? 15 : h < 535.11 ? 16 : h < 535.19 ? 17 : h < 536.05 ? 18 : h < 536.1 ? 19 : h < 537.01 ? 20 : h < 537.11 ? '21+' : h < 537.13 ? 23 : h < 537.18 ? 24 : h < 537.24 ? 25 : h < 537.36 ? 26 : 'Blink' != D ? '27' : '28')))
								: (D && (D[1] = 'like Safari'), (h = (h = h[0]) < 400 ? 1 : h < 500 ? 2 : h < 526 ? 3 : h < 533 ? 4 : h < 534 ? '4+' : h < 535 ? 5 : h < 537 ? 6 : h < 538 ? 7 : h < 601 ? 8 : '8')),
							D && (D[1] += ' ' + (h += 'number' == typeof h ? '.x' : /[.+]/.test(h) ? '' : '+')),
							'Safari' == L && (!F || parseInt(F) > 45) && (F = h)),
							'Opera' == L && (h = /\bzbov|zvav$/.exec(H)) ? ((L += ' '), U.unshift('desktop mode'), 'zvav' == h ? ((L += 'Mini'), (F = null)) : (L += 'Mobile'), (H = H.replace(RegExp(' *' + h + '$'), ''))) : 'Safari' == L && /\bChrome\b/.exec(D && D[1]) && (U.unshift('desktop mode'), (L = 'Chrome Mobile'), (F = null), /\bOS X\b/.test(H) ? ((q = 'Apple'), (H = 'iOS 4.3+')) : (H = null)),
							F && 0 == F.indexOf((h = /[\d.]+$/.exec(H))) && n.indexOf('/' + h + '-') > -1 && (H = f(H.replace(h, ''))),
							D && !/\b(?:Avant|Nook)\b/.test(L) && (/Browser|Lunascape|Maxthon/.test(L) || ('Safari' != L && /^iOS/.test(H) && /\bSafari\b/.test(D[1])) || (/^(?:Adobe|Arora|Breach|Midori|Opera|Phantom|Rekonq|Rock|Samsung Internet|Sleipnir|Web)/.test(L) && D[1])) && (h = D[D.length - 1]) && U.push(h),
							U.length && (U = ['(' + U.join('; ') + ')']),
							q && B && B.indexOf(q) < 0 && U.push('on ' + q),
							B && U.push((/^on /.test(U[U.length - 1]) ? '' : 'on ') + B),
							H &&
								((h = / ([\d.+]+)$/.exec(H)),
							...
							(h = /\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(R)) && !/\bi686\b/i.test(R) ? (H && ((H.architecture = 64), (H.family = H.family.replace(RegExp(' *' + h), ''))), L && (/\bWOW64\b/i.test(n) || (N && /\w(?:86|32)$/.test(c.cpuClass || c.platform) && !/\bWin64; x64\b/i.test(n))) && U.unshift('32-bit')) : H && /^OS X/.test(H.family) && 'Chrome' == L && parseFloat(F) >= 39 && (H.architecture = 64),
							n || (n = null);
						var z = {};
						return (
							(z.description = n),
							...
							z.version && U.unshift(F),
							z.name && U.unshift(L),
							H && L && (H != String(H).split(' ')[0] || (H != L.split(' ')[0] && !B)) && U.push(B ? '(' + H + ')' : 'on ' + H),
		...
		function(e, t, n) {
			...
			(p.init = function() {
				d.init.call(this),
					...
					(this.timetags = {}),
					(this.sysMsgUnread = l.completeUnread({})),
		...
		function(e, t, n) {
			...
			(c.info = u.info = i.info), (e.exports = c), n(402), n(401), n(400), n(399), n(398), n(397), n(396), n(395), n(394), n(393), n(392), n(391), n(390), n(389), n(388), n(387), n(386);
		},
		function(e, t) {
			var n = {}.toString;
			e.exports = function(e) {
		...
		function(e, t, n) {
			...
			(p.updatePrivateConf = function(e) {
				...
				return null === e.ntServerAddress || '' === e.ntServerAddress ? (l.ntServerAddress = null) : (l.ntServerAddress = e.ntServerAddress || l.defaultReportUrl), (l.uploadUrl = e.uploadUrl || l.uploadUrl), (l.chunkUploadUrl = e.chunkUploadUrl || l.chunkUploadUrl), (l.downloadUrl = e.downloadUrl || l.downloadUrl), (l.downloadHost = e.downloadHost || l.downloadHost), (l.replaceUrl = e.replaceUrl || l.replaceUrl), (l.httpsEnabled = e.httpsEnabled || l.httpsEnabled), e;
			}),
				(p.init = function(e) {
					...
					(this.name = n), (d[n] = this), (this.logger = e.logger = new u({ debug: e.debug, logFunc: e.logFunc, prefix: this.subType })), (e.api = this);
			...
			var g = function(e, t, n, r, s) {
				...
				n && (i = 'api::processCallbackPromise'),
					...
					(e.callback = function(o, u, l) {
						...
						var p = e.done;
						a.isObject(u) && (delete u.done, delete u.cb, delete u.callback), n ? (o ? s({ message: '生成接口回调错误', callFunc: i, event: o }) : r(u)) : p(o, u, l);
					}),
		...
		function(e, t, n) {
			'use strict';
			var r = n(448);
			(r.fn = r.prototype), (e.exports = r), n(445), n(444), n(443), n(442), n(441), n(440), n(439), n(438), n(437), n(436);
		},
		function(e, t, n) {
			var r = n(19),
				s = n(8).document,
		...
		function(e, t, n) {
			...
			s.init(), (s.clientTypeMap = { 1: 'Android', 2: 'iOS', 4: 'PC', 8: 'WindowsPhone', 16: 'Web', 32: 'Server', 64: 'Mac' }), (s.db = { open: function() {} }), (e.exports = s);
		},
		function(e, t, n) {
			n(99);
			for (
		...
		function(e, t, n) {
			...
			var r = n(0),
				...
				i = n(26);
			function o(e) {
				r.undef(e.secure) && (e.secure = !0), (this.options = r.copy(e)), (this.keepNosSafeUrl = this.options.keepNosSafeUrl || !1), this.init(), this.connect(), (this.initConnecting = !0);
			}
			...
			(a.init = function() {
				...
				(a.executeCmdTask = function(e) {
					...
					this.isFrequencyControlled(t)
						? (this.logger.warn('protocol::executeCmdTask: ' + t + ' hit freq control'), this.markCallbackInvalid(r, i.newFrequencyControlError({ callFunc: 'protocol::executeCmdTask', message: t + ' hit freq control' })))
						: this.isConnected()
						? ('heartbeat' !== t && this.logger.log('protocol::sendCmd: ' + t + ' ' + JSON.stringify(n)), this.doSendCmd(n))
						: (this.logger.warn('protocol::executeCmdTask: ' + t + ' not connected'), this.markCallbackInvalid(r, i.newSocketStateError({ callFunc: 'protocol::executeCmdTask', message: t + ' not connected' })));
				}),
				...
				(a.doSendCmd = function(e) {
					var t = this,
						n = e.SER;
					function r() {
						t.markCallbackInvalid(n, i.newSocketStateError({ callFunc: 'protocol::doSendCmd', message: 'ser ' + n + ' socketSendJson Error' })), t.onDisconnect(!0, 'protocol::doSendCmd:socketSendJson');
					}
					t.timerMap[n] = setTimeout(function() {
						t.markCallbackInvalid(n, i.newTimeoutError({ callFunc: 'protocol::doSendCmd', message: 'ser ' + n + ' Timeout Error' }));
					}, s.cmdTimeout);
					try {
				...
				(a.callPacketAckCallback = function(e) {
					...
					if (e && e.raw) {
						...
						if (r.notundef(n)) {
							...
							s &&
								(s.originUrl && e.obj && e.obj.file && ((e.obj.file._url_safe = e.obj.file.url), (e.obj.file.url = s.originUrl), 'audio' === e.obj.type && (e.obj.file.mp3Url = s.originUrl + (~s.originUrl.indexOf('?') ? '&' : '?') + 'audioTrans&type=mp3')),
								e.promise
									? e.promise.then(
											function() {
												s(e.error, e.obj);
					...
					t.heartbeat(),
						t.parser.parseResponse(e).then(function(e) {
							e.notFound && t.logger.warn('protocol::onMessage: packet not found ' + JSON.stringify(e)),
								e.error ? ((e.error.message = e.cmd + ' error: ' + e.error.message), t.logger.error('protocol::onMessage: packet error ' + JSON.stringify(e.error))) : e.content || 'heartbeat' === e.cmd || t.logger.warn('protocol::onMessage: packet.content undefined ' + JSON.stringify(e)),
								e.frequencyControlDuration && (t.logger.error('protocol::onMessage: server freq control ' + JSON.stringify(e.cmd)), (t.frequencyControlMap = t.frequencyControlMap || {}), (t.frequencyControlMap[e.cmd] = { from: +new Date(), duration: e.frequencyControlDuration })),
							...
							if (t[n])
								if (('heartbeat' !== e.cmd && t.logger.warn('protocol::recvCmd: ' + e.cmd + ' ' + n, e.content), 'syncDone' === e.cmd)) {
									if (t.cmdCallbackMap[e.raw.ser] && t.cmdCallbackMap[e.raw.ser].isImSyncDataCb) {
										t.cmdCallbackMap[e.raw.ser].isImSyncDataCb = !1;
										var s = function(e, t) {
											this.checkNosReqNum++, this.getNosOriginUrlReqNum <= 0 || this.checkNosReqNum >= 10 ? this[e](t) : setTimeout(s, 300);
										}.bind(t, n, e);
										s.call(t, n, e);
									}
								} else t[n](e);
		...
		function(e, t, n) {
			...
			e.exports = function(e, t, n, f, g, h, y) {
				...
				if (
					(w && (M = l(w.call(new e()))) !== Object.prototype && M.next && (u(M, S, !0), r || 'function' == typeof M[m] || o(M, m, p)),
					k &&
						I &&
						'values' !== I.name &&
						((C = !0),
					...
					if (((v = { values: k ? O : T('values'), keys: h ? O : T('keys'), entries: x }), y)) for (b in v) b in P || i(P, b, v[b]);
		...
		function(e, t, n) {
			...
			function o(e) {
				...
				var t = (e = this.options = r.fetch({ method: 'GET', url: '', sync: !1, data: null, headers: {}, cookie: !1, timeout: 6e4, type: 'text', form: null, input: null, putFileAtEnd: !1, proxyUrl: '' }, e)).headers;
		...
		function(e, t, n) {
			...
			function p(e) {
				e.resend ? (a.verifyOptions(e, 'idClient', 'msg::Message'), (this.idClient = e.idClient)) : (this.idClient = a.guid()),
					...
					c(e.antiSpamContent) && ('object' === (0, i.default)(e.antiSpamContent) ? (this.antiSpamContent = JSON.stringify(e.antiSpamContent)) : (this.antiSpamContent = '' + e.antiSpamContent)),
					c(e.antiSpamBusinessId) && ('object' === (0, i.default)(e.antiSpamBusinessId) ? (this.antiSpamBusinessId = JSON.stringify(e.antiSpamBusinessId)) : (this.antiSpamBusinessId = '' + e.antiSpamBusinessId)),
			...
			(p.validTypes = m.validTypes),
				a.merge(p.prototype, m.prototype),
				(p.getType = m.getType),
				(p.reverse = function(e) {
					...
					return c(t.fromAvatar) && (t.fromAvatar = (0, o.genPrivateUrl)(t.fromAvatar)), (t = a.merge(t, { fromClientType: l.reverseType(e.fromClientType), time: +e.time, type: p.getType(e), text: u(e.body) ? e.body : '', resend: 1 == +e.resend })), c(t.userUpdateTime) && (t.userUpdateTime = +t.userUpdateTime), (t.status = t.status || 'success'), t;
				}),
		...
		function(e, t, n) {
			...
			o.merge(v.prototype, m.prototype),
		...
		function(e, t, n) {
			...
			var r = {
					...
					misc: { id: 6, getSimpleNosToken: 1, getNosToken: 2, notifyUploadLog: 3, uploadSdkLogUrl: 4, audioToText: 5, processImage: 6, getNosTokenTrans: 7, notifyTransLog: 8, fetchFile: 9, fetchFileList: 10, removeFile: 11, getClientAntispam: 17, fileQuickTransfer: 18, getNosOriginUrl: 22 },
					avSignal: { id: 15, signalingCreate: 1, signalingDelay: 2, signalingClose: 3, signalingJoin: 4, signalingLeave: 5, signalingInvite: 6, signalingCancel: 7, signalingReject: 8, signalingAccept: 9, signalingControl: 10, signalingNotify: 11, signalingMutilClientSyncNotify: 12, signalingUnreadMessageSyncNotify: 13, signalingChannelsSyncNotify: 14, signalingGetChannelInfo: 15 }
				},
				s = {
					...
					getNosToken: { sid: r.misc.id, cid: r.misc.getNosToken, params: [{ type: 'String', name: 'responseBody' }, { type: 'Property', name: 'nosToken', entity: 'nosToken' }] },
					...
					processImage: { sid: r.misc.id, cid: r.misc.processImage, params: [{ type: 'String', name: 'url' }, { type: 'PropertyArray', name: 'imageOps', entity: 'imageOp' }] },
			...
			e.exports = {
				...
				packetConfig: {
					...
					'6_7': { service: 'misc', cmd: 'getNosTokenTrans', response: [{ type: 'Property', name: 'nosToken' }, { type: 'String', name: 'docId' }] },
					...
					'6_10': { service: 'misc', cmd: 'fetchFileList', response: [{ type: 'PropertyArray', name: 'list', entity: 'transInfo' }, { type: 'Number', name: 'totalCount' }] },
		...
		function(e, t, n) {
				...
				(p.prototype.parseResponse = function(e) {
					...
					return new Promise(function(n, r) {
						...
						if (((a.isNotify = l), l)) {
							...
							if (((c = t.configMap.packetConfig[m.sid + '_' + m.cid]), (u = s.r[1].body), !c)) return (a.notFound = { sid: m.sid, cid: m.cid }), void n(a);
						}
						if (((a.service = c.service), (a.cmd = c.cmd), a.error)) {
							var d = s.sid + '_' + s.cid;
							if ((l && (d = m.sid + '_' + m.cid), (a.error.cmd = a.cmd), (a.error.callFunc = 'protocol::parseResponse: ' + d), 416 === a.error.code)) {
								var p = u[0];
						...
						if ((!a.error || f) && c.response) {
							...
							var h = function(e, t, n, r) {
								if ((e && 'msg' === r) || 'sysMsg' === r) {
									var s = n.content[r];
									i.isObject(s) && !s.idServer && ((s.idServer = '' + t.r[0]), s.type && '8' === s.type && s.deletedIdClient && (s.idServer = s.deletedIdClient));
								}
							};
				...
				(p.prototype.getOneNosOriginUrl = function(e, t, n) {
					...
					return new Promise(function(s, i) {
						r.protocol.getNosOriginUrlReqNum++,
							r.protocol.sendCmd('getNosOriginUrl', { nosFileUrlTag: { safeUrl: e } }, function(e, r, i) {
								e ? console.warn('error: get nos originUrl failed', e) : ((t['_' + n + '_safe'] = t[n]), (t[n] = i.nosFileUrlTag && i.nosFileUrlTag.originUrl)), s();
							});
					});
				}),
			...
			var g = new p({ configMap: a, serializeMap: c, unserializeMap: u }),
				h = new p({ configMap: l, serializeMap: m, unserializeMap: d });
				...
				f = function() {
					...
					if (e && 0 === e.indexOf('MSG|')) {
						...
						(n && '*' !== n && 0 !== location.href.toLowerCase().indexOf(n)) ||
							...
							})({ data: JSON.parse(t.data || 'null'), source: s.frames[t.self] || t.self, origin: p(t.ref || document.referrer) });
					}
				},
				g = ((m = function(e, t) {
		...
		function(e, t, n) {
			...
			(a.reverse = function(e) {
				...
				(a.assembleMember = function(e, t) {
					return { id: a.genId(e.teamId, t), account: t, teamId: e.teamId, type: 'normal', nickInTeam: '', muteTeam: !1, mute: !1, joinTime: e.memberUpdateTime, updateTime: e.memberUpdateTime, active: !0, valid: !0 };
				}),
		...
		function(e, t, n) {
			'use strict';
			var r = n(2);
			'undefined' != typeof window && (window.console || r.isWeixinApp || (window.console = { log: function() {}, info: function() {}, warn: function() {}, error: function() {} }));
		},
		function(e, t, n) {
			n(39)('observable');
		},
		...
		function(e, t, n) {
			...
			var r = n(8),
				...
				X = function(e, t, n) {
					return e === B && X(L, t, n), v(e), (t = T(t, !0)), v(n), s(D, t) ? (n.enumerable ? (s(e, U) && e[U][t] && (e[U][t] = !1), (n = k(n, { enumerable: S(0, !1) }))) : (s(e, U) || w(e, U, S(1, {})), (e[U][t] = !0)), z(e, t, n)) : w(e, t, n);
				},
				$ = function(e, t) {
					v(e);
			...
			q ||
				(a(
					(_ = function() {
						...
						var e = d(arguments.length > 0 ? arguments[0] : void 0),
							t = function(n) {
								this === B && t.call(L, n), s(this, U) && s(this[U], e) && (this[U][e] = !1), z(this, e, S(1, n));
							};
						return i && W && z(B, e, { configurable: !0, set: t }), J(e);
					}).prototype,
					'toString',
					function() {
						return this._k;
				...
				(n(28).f = G),
				(n(38).f = Y),
				i && !n(35) && a(B, 'propertyIsEnumerable', G, !0),
				(f.f = function(e) {
					return J(p(e));
				})),
		...
		function(e, t, n) {
			...
			var o = n(0),
				...
				l = n(119),
				m = n(86),
				d = { customP2p: 100, customTeam: 101, deleteMsgP2p: 7, deleteMsgTeam: 8 },
				p = { 0: 'applyTeam', 1: 'rejectTeamApply', 2: 'teamInvite', 3: 'rejectTeamInvite', 5: 'friendRequest', 6: 'deleteFriend', 7: 'deleteMsgP2p', 8: 'deleteMsgTeam', 100: 'customP2p', 101: 'customTeam', 102: 'customP2p' },
				f = { 1: 'addFriend', 2: 'applyFriend', 3: 'passFriendApply', 4: 'rejectFriendApply' },
				g = ['team', 'friend', 'msg'],
				h = { applyTeam: 'team', rejectTeamApply: 'team', teamInvite: 'team', rejectTeamInvite: 'team', addFriend: 'friend', applyFriend: 'friend', passFriendApply: 'friend', rejectFriendApply: 'friend', deleteFriend: 'friend', deleteMsg: 'msg' };
			function y(e) {
				o.verifyOptions(e, 'type to', 'sysmsg::SystemMessage'),
					...
					-1 !== e.type.indexOf('custom') &&
						...
						c(e.pushPayload) && ('object' === (0, i.default)(e.pushPayload) ? (this.pushPayload = JSON.stringify(e.pushPayload)) : (this.pushPayload = '' + e.pushPayload)),
				...
				(y.reverse = function(e) {
					...
					if (
						...
						if (e.attach) {
							...
							c(n.vt) ? ((t.type = f[n.vt]), delete t.attach) : (c(n.tinfo) && (t.attach.team = l.reverse(u.syncUnserialize(n.tinfo, 'team'))), c(n.tlist) && (t.attach.member = m.reverse(u.syncUnserialize(n.tlist, 'teamMember'))), c(n.attach) && (t.attach.custom = n.attach));
						}
		...
		function(e, t, n) {
			...
			var r = n(2),
				...
				i = (n(0), n(49));
			e.exports = function(e, t, n) {
				var o = { file: e.data[t], fileSize: e.data[t].size, fileUoloadedSize: 0, percentage: 0 };
				function a(t) {
					var n = o.fileUoloadedSize + t.loaded,
						r = Math.floor((1e4 * n) / o.fileSize) / 100;
					if ((parseInt(r) >= 100 && ((r = 100), (a = function() {})), o.percentage !== r)) {
						o.percentage = r;
						var s = { docId: e.docId, total: o.fileSize, loaded: n, percentage: r, percentageText: r + '%' };
				...
				function c(t) {
					...
					if (t.errMsg || t.errCode) n.onError(t);
						...
						delete l.onaftersend,
							(o.fileUoloadedSize = t.offset),
							(n.sn = (function(e, t, n, r, o) {
								var l = t.offset,
									m = t.offset + s;
								return (n.data = o.file.slice(l, m)), (n.query.offset = t.offset), (n.query.complete = m >= o.fileSize), (n.query.context = t.context), (n.onuploading = a), (n.onload = c), (n.onerror = u), i(e, n);
							})(e.url, t, l, 0, o));
					else {
						var m = function(e) {
								n.onError(e);
						...
						'image' === e.type
							? i(d + '?imageInfo', {
									onload: function(n) {
										try {
											(n = JSON.parse(n)), e.uploaddone(null, { docId: t.docId, w: n.Width, h: n.Height, orientation: n.Orientation || '', type: n.Type, size: n.Size || o.fileSize });
										} catch (e) {
											m(e);
										}
									},
							...
							? i(d + '?vinfo', {
									onload: function(n) {
										try {
											(n = JSON.parse(n)).GetVideoInfo && n.GetVideoInfo.VideoInfo && (n = n.GetVideoInfo.VideoInfo), e.uploaddone(null, { docId: t.docId, w: n.Width, h: n.Height, dur: n.Duration, orientation: n.Rotate, audioCodec: n.AudioCodec, videoCodec: n.VideoCodec, container: n.Container, size: n.Size || o.fileSize });
										} catch (e) {
											m(e);
										}
									},
							...
							: e.uploaddone(null, { docId: t.docId, size: o.fileSize });
					}
				}
				function u(e) {
					try {
				...
				var l = {
					query: { offset: 0, complete: s >= o.fileSize, version: '1.0' },
					headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'x-nos-token': e.nosToken.token },
					method: 'POST',
					timeout: 0,
						...
						!(function(e, t) {
							...
							(n.version = '0.9.11'),
								...
								(n.connect = function(e, r) {
									...
									var a = { host: o.host, secure: 'https' === o.protocol, port: o.port || ('https' === o.protocol ? 443 : 80), query: o.query || '' };
								...
								function str(e, t) {
									...
									switch ((c instanceof Date && (c = date(e)), 'function' == typeof rep && (c = rep.call(t, e, c)), typeof c)) {
										...
										case 'object':
											...
											if (rep && 'object' == typeof rep) for (i = rep.length, n = 0; n < i; n += 1) 'string' == typeof rep[n] && (s = str((r = rep[n]), c)) && o.push(quote(r) + (gap ? ': ' : ':') + s);
							...
							(function(e, t, n) {
								function r(e) {
									if (
										((this.options = { port: 80, secure: !1, document: 'document' in n && document, resource: 'socket.io', transports: e.transports || t.transports, 'connect timeout': 1e4, 'try multiple transports': !0, reconnect: !0, 'reconnection delay': 500, 'reconnection limit': 1 / 0, 'reopen delay': 3e3, 'max reconnection attempts': 10, 'sync disconnect on unload': !1, 'auto connect': !0, 'flash policy port': 10843, manualFlush: !1 }),
										...
										return (
											...
											this.handshake(function(r, s, i, o) {
												(n.sessionid = r),
													...
													console.log('SocketIO transports: ' + n.transports + ' opt:' + n.options.transports),
												...
												return e.connected
													...
													: void (e.reconnectionAttempts++ >= t
															? e.redoTransports
																...
																: (e.on('connect_failed', i), (e.options['try multiple transports'] = !0), (e.transports = e.origTransports), (e.transport = e.getTransport()), (e.redoTransports = !0), e.connect())
															: (e.reconnectionDelay < r && (e.reconnectionDelay *= 2), e.connect(), e.publish('reconnecting', e.reconnectionDelay, e.reconnectionAttempts), (e.reconnectionTimer = setTimeout(i, e.reconnectionDelay))));
										}
		...
		function(e, t, n) {
			'use strict';
			var r = n(0),
				s = { file: { md5: '$(Etag)', size: '$(ObjectSize)' }, image: { md5: '$(Etag)', size: '$(ObjectSize)', w: '$(ImageInfo.Width)', h: '$(ImageInfo.Height)', orientation: '$(ImageInfo.Orientation)' }, audio: { md5: '$(Etag)', size: '$(ObjectSize)', dur: '$(AVinfo.Audio.Duration)' }, video: { md5: '$(Etag)', size: '$(ObjectSize)', dur: '$(AVinfo.Video.Duration)', w: '$(AVinfo.Video.Width)', h: '$(AVinfo.Video.Height)' } },
				i = {
		...
		function(e, t, n) {
			...
			var r = n(22),
				...
				p = n(275);
			e.exports = function(e) {
				c.merge(e, { platform: r, xhr: s, io: i, naturalSort: o, deepAccess: a, util: c, support: u, blob: l, ajax: m, LoggerPlugin: d, usePlugin: p });
			};
		},
		function(e, t, n) {
			'use strict';
			var r = n(0),
				...
				i = r.merge({}, s.idMap, {
					...
					user: { id: 3, updatePushToken: 1, appBackground: 2, markInBlacklist: 3, getBlacklist: 4, markInMutelist: 5, getMutelist: 6, getRelations: 8, getUsers: 7, updateMyInfo: 10, updateDonnop: 15, syncMyInfo: 109, syncUpdateMyInfo: 110 },
					notify: { id: 4, markRead: 3, syncOfflineMsgs: 4, batchMarkRead: 5, syncOfflineSysMsgs: 6, syncRoamingMsgs: 9, syncMsgReceipts: 12, syncRobots: 15, syncBroadcastMsgs: 16 },
					sync: { id: 5, sync: 1, syncTeamMembers: 2 },
					msg: { id: 7, sendMsg: 1, msg: 2, sysMsg: 3, getHistoryMsgs: 6, sendCustomSysMsg: 7, searchHistoryMsgs: 8, deleteSessions: 9, getSessions: 10, syncSendMsg: 101, sendMsgReceipt: 11, msgReceipt: 12, deleteMsg: 13, msgDeleted: 14, markSessionAck: 16, broadcastMsg: 17, clearServerHistoryMsgs: 18 },
					team: {
						id: 8,
						createTeam: 1,
						sendTeamMsg: 2,
					...
					eventService: { id: 14, publishEvent: 1, pushEvent: 2, subscribeEvent: 3, unSubscribeEventsByAccounts: 4, unSubscribeEventsByType: 5, querySubscribeEventsByAccounts: 6, querySubscribeEventsByType: 7, pushEvents: 9 }
				}),
				o = r.merge({}, s.cmdConfig, {
					...
					updatePushToken: { sid: i.user.id, cid: i.user.updatePushToken, params: [{ type: 'String', name: 'tokenName' }, { type: 'String', name: 'token' }, { type: 'int', name: 'pushkit' }] },
					appBackground: { sid: i.user.id, cid: i.user.appBackground, params: [{ type: 'bool', name: 'isBackground' }, { type: 'Int', name: 'badge' }] },
					markInBlacklist: { sid: i.user.id, cid: i.user.markInBlacklist, params: [{ type: 'String', name: 'account' }, { type: 'bool', name: 'isAdd' }] },
					getBlacklist: { sid: i.user.id, cid: i.user.getBlacklist, params: [{ type: 'long', name: 'time' }] },
					markInMutelist: { sid: i.user.id, cid: i.user.markInMutelist, params: [{ type: 'String', name: 'account' }, { type: 'bool', name: 'isAdd' }] },
					...
					markRead: { sid: i.notify.id, cid: i.notify.markRead, params: [{ type: 'long', name: 'id' }, { type: 'ph', name: 'ph' }] },
					batchMarkRead: { sid: i.notify.id, cid: i.notify.batchMarkRead, params: [{ type: 'byte', name: 'sid' }, { type: 'byte', name: 'cid' }, { type: 'LongArray', name: 'ids' }] },
					...
					getHistoryMsgs: { sid: i.msg.id, cid: i.msg.getHistoryMsgs, params: [{ type: 'String', name: 'to' }, { type: 'long', name: 'beginTime' }, { type: 'long', name: 'endTime' }, { type: 'long', name: 'lastMsgId' }, { type: 'int', name: 'limit' }, { type: 'bool', name: 'reverse' }, { type: 'LongArray', name: 'msgTypes' }] },
					sendCustomSysMsg: { sid: i.msg.id, cid: i.msg.sendCustomSysMsg, params: [{ type: 'Property', name: 'sysMsg' }] },
					searchHistoryMsgs: { sid: i.msg.id, cid: i.msg.searchHistoryMsgs, params: [{ type: 'String', name: 'to' }, { type: 'long', name: 'beginTime' }, { type: 'long', name: 'endTime' }, { type: 'String', name: 'keyword' }, { type: 'int', name: 'limit' }, { type: 'bool', name: 'reverse' }] },
					...
					markSessionAck: { sid: i.msg.id, cid: i.msg.markSessionAck, params: [{ type: 'byte', name: 'scene' }, { type: 'String', name: 'to' }, { type: 'long', name: 'timetag' }] },
					clearServerHistoryMsgs: { sid: i.msg.id, cid: i.msg.clearServerHistoryMsgs, params: [{ type: 'Property', name: 'clearMsgsParams' }] },
					createTeam: { sid: i.team.id, cid: i.team.createTeam, params: [{ type: 'Property', name: 'team' }, { type: 'StrArray', name: 'accounts' }, { type: 'String', name: 'ps' }] },
					sendTeamMsg: { sid: i.team.id, cid: i.team.sendTeamMsg, params: [{ type: 'Property', name: 'msg' }] },
					addTeamMembers: { sid: i.team.id, cid: i.team.addTeamMembers, params: [{ type: 'long', name: 'teamId' }, { type: 'StrArray', name: 'accounts' }, { type: 'String', name: 'ps' }, { type: 'String', name: 'attach' }] },
					removeTeamMembers: { sid: i.team.id, cid: i.team.removeTeamMembers, params: [{ type: 'long', name: 'teamId' }, { type: 'StrArray', name: 'accounts' }] },
					...
					getTeamMembers: { sid: i.team.id, cid: i.team.getTeamMembers, params: [{ type: 'long', name: 'teamId' }, { type: 'long', name: 'timetag' }] },
					dismissTeam: { sid: i.team.id, cid: i.team.dismissTeam, params: [{ type: 'long', name: 'teamId' }] },
					applyTeam: { sid: i.team.id, cid: i.team.applyTeam, params: [{ type: 'long', name: 'teamId' }, { type: 'String', name: 'ps' }] },
					passTeamApply: { sid: i.team.id, cid: i.team.passTeamApply, params: [{ type: 'long', name: 'teamId' }, { type: 'String', name: 'from' }] },
					rejectTeamApply: { sid: i.team.id, cid: i.team.rejectTeamApply, params: [{ type: 'long', name: 'teamId' }, { type: 'String', name: 'from' }, { type: 'String', name: 'ps' }] },
					addTeamManagers: { sid: i.team.id, cid: i.team.addTeamManagers, params: [{ type: 'long', name: 'teamId' }, { type: 'StrArray', name: 'accounts' }] },
					removeTeamManagers: { sid: i.team.id, cid: i.team.removeTeamManagers, params: [{ type: 'long', name: 'teamId' }, { type: 'StrArray', name: 'accounts' }] },
					transferTeam: { sid: i.team.id, cid: i.team.transferTeam, params: [{ type: 'long', name: 'teamId' }, { type: 'String', name: 'account' }, { type: 'bool', name: 'leave' }] },
					...
					acceptTeamInvite: { sid: i.team.id, cid: i.team.acceptTeamInvite, params: [{ type: 'long', name: 'teamId' }, { type: 'String', name: 'from' }] },
					rejectTeamInvite: { sid: i.team.id, cid: i.team.rejectTeamInvite, params: [{ type: 'long', name: 'teamId' }, { type: 'String', name: 'from' }, { type: 'String', name: 'ps' }] },
					getTeamHistoryMsgs: { sid: i.team.id, cid: i.team.getTeamHistoryMsgs, params: [{ type: 'long', name: 'to' }, { type: 'long', name: 'beginTime' }, { type: 'long', name: 'endTime' }, { type: 'long', name: 'lastMsgId' }, { type: 'int', name: 'limit' }, { type: 'bool', name: 'reverse' }, { type: 'LongArray', name: 'msgTypes' }] },
					searchTeamHistoryMsgs: { sid: i.team.id, cid: i.team.searchTeamHistoryMsgs, params: [{ type: 'long', name: 'to' }, { type: 'long', name: 'beginTime' }, { type: 'long', name: 'endTime' }, { type: 'String', name: 'keyword' }, { type: 'int', name: 'limit' }, { type: 'bool', name: 'reverse' }] },
					updateMuteStateInTeam: { sid: i.team.id, cid: i.team.updateMuteStateInTeam, params: [{ type: 'long', name: 'teamId' }, { type: 'String', name: 'account' }, { type: 'int', name: 'mute' }] },
					...
					muteTeamAll: { sid: i.team.id, cid: i.team.muteTeamAll, params: [{ type: 'long', name: 'teamId' }, { type: 'int', name: 'muteType' }] },
					friendRequest: { sid: i.friend.id, cid: i.friend.friendRequest, params: [{ type: 'String', name: 'account' }, { type: 'byte', name: 'type' }, { type: 'String', name: 'ps' }] },
					deleteFriend: { sid: i.friend.id, cid: i.friend.deleteFriend, params: [{ type: 'String', name: 'account' }, { type: 'Property', name: 'delFriendParams' }] },
					...
					getChatroomAddress: { sid: i.chatroom.id, cid: i.chatroom.getChatroomAddress, params: [{ type: 'long', name: 'chatroomId' }, { type: 'bool', name: 'isWeixinApp' }] },
					...
					subscribeEvent: { sid: i.eventService.id, cid: i.eventService.subscribeEvent, params: [{ type: 'Property', name: 'msgEventSubscribe' }, { type: 'StrArray', name: 'accounts' }] },
					unSubscribeEventsByAccounts: { sid: i.eventService.id, cid: i.eventService.unSubscribeEventsByAccounts, params: [{ type: 'Property', name: 'msgEventSubscribe' }, { type: 'StrArray', name: 'accounts' }] },
					...
					querySubscribeEventsByAccounts: { sid: i.eventService.id, cid: i.eventService.querySubscribeEventsByAccounts, params: [{ type: 'Property', name: 'msgEventSubscribe' }, { type: 'StrArray', name: 'accounts' }] },
					querySubscribeEventsByType: { sid: i.eventService.id, cid: i.eventService.querySubscribeEventsByType, params: [{ type: 'Property', name: 'msgEventSubscribe' }] },
					pushEvents: { sid: i.eventService.id, cid: i.eventService.pushEvents }
				}),
				a = r.merge({}, s.packetConfig, {
					'2_3': { service: 'auth', cmd: 'login', response: [{ type: 'Property', name: 'loginRes' }, { type: 'PropertyArray', name: 'loginPorts', entity: 'loginPort' }, { type: 'Property', name: 'aosPushInfo' }] },
					...
					'8_1': { service: 'team', cmd: 'createTeam', response: [{ type: 'Property', name: 'team' }, { type: 'StrArray', name: 'abortedAccidList' }] },
					...
					'8_5': { service: 'team', cmd: 'addTeamMembers', response: [{ type: 'long', name: 'time' }, { type: 'StrArray', name: 'abortedAccidList' }] },
					...
					'8_30': { service: 'team', cmd: 'getTeamMsgReadAccounts', response: [{ type: 'String', name: 'idClient' }, { type: 'StrArray', name: 'readAccounts' }, { type: 'StrArray', name: 'unreadAccounts' }] },
					...
					'14_6': { service: 'eventService', cmd: 'querySubscribeEventsByAccounts', response: [{ type: 'PropertyArray', name: 'msgEventSubscribes', entity: 'msgEventSubscribe' }] },
					'14_7': { service: 'eventService', cmd: 'querySubscribeEventsByType', response: [{ type: 'PropertyArray', name: 'msgEventSubscribes', entity: 'msgEventSubscribe' }] },
		...
		function(e, t, n) {
			(function(t, n) {
				...
				(r = function() {
					...
					function A(t, n, r) {
						n.constructor === t.constructor && r === T && n.constructor.resolve === S
							? (function(e, t) {
									t._state === I
										? R(e, t._result)
										: t._state === O
					...
					function F(t, n, r, s) {
						...
						if (i) {
							if (
								...
								return void U(n, new TypeError('A promises callback cannot return that same promise.'));
						} else (o = s), (c = !0);
					...
					var B = (function() {
						...
						return (
							...
							(e.prototype._settledAt = function(e, t, n) {
								var r = this.promise;
								r._state === P && (this._remaining--, e === O ? U(r, n) : (this._result[t] = n)), 0 === this._remaining && R(r, this._result);
							}),
		...
		function(e, t, n) {
			...
			var r = n(54);
			function s() {}
			s.typeMap = { text: 0, image: 1, audio: 2, video: 3, geo: 4, notification: 5, file: 6, tip: 10, robot: 11, custom: 100 };
			var i = (s.typeReverseMap = { 0: 'text', 1: 'image', 2: 'audio', 3: 'video', 4: 'geo', 5: 'notification', 6: 'file', 10: 'tip', 11: 'robot', 100: 'custom' });
		...
		function(e, t, n) {
			...
			function u(e) {
				...
				if (
					('json' in e && !1 !== e.json && ((h = !0), f.accept || f.Accept || (f.Accept = 'application/json'), 'GET' !== d && 'HEAD' !== d && (f['content-type'] || f['Content-Type'] || (f['Content-Type'] = 'application/json'), (p = JSON.stringify(!0 === e.json ? p : e.json)))),
					(u.onreadystatechange = function() {
		...
		function(e, t, n) {
			'use strict';
			e.exports = {
				imLogin: { 3: 'clientType', 4: 'os', 6: 'sdkVersion', 8: 'appLogin', 9: 'protocolVersion', 10: 'pushTokenName', 11: 'pushToken', 13: 'deviceId', 18: 'appKey', 19: 'account', 24: 'browser', 26: 'session', 32: 'deviceInfo', 38: 'customTag', 112: 'isReactNative', 1000: 'token' },
				...
				robot: { 4: 'account', 5: 'nick', 6: 'avatar', 7: 'intro', 8: 'config', 9: 'valid', 10: 'createTime', 11: 'updateTime', 12: 'custid', 13: 'botid', 14: 'bindTime', _6_safe: '_avatar_safe' },
				...
				transInfo: { 1: 'docId', 2: 'name', 3: 'prefix', 4: 'size', 5: 'type', 6: 'state', 7: 'transType', 8: 'transSize', 9: 'pageCount', 10: 'picInfo', 11: 'extra', 12: 'flag' },
				nosFileUrlTag: { 0: 'safeUrl', 1: 'originUrl' },
				fileListParam: { 1: 'fromDocId', 2: 'limit' },
				avSignalTag: { 1: 'type', 2: 'channelName', 3: 'channelId', 4: 'channelCreateTime', 5: 'channelExpireTime', 6: 'creator', 7: 'ext', 8: 'channelInValid', 10: 'from', 11: 'to', 12: 'requestId', 13: 'needPush', 14: 'pushTitle', 15: 'pushContent', 16: 'pushPayload', 17: 'needBadge', 18: 'members', 19: 'attach', 20: 'attachExt', 21: 'isSave', 22: 'msgid', 23: 'uid', 24: 'time' },
				login: { 1: 'appKey', 2: 'account', 3: 'deviceId', 5: 'chatroomId', 8: 'appLogin', 20: 'chatroomNick', 21: 'chatroomAvatar', 22: 'chatroomCustom', 23: 'chatroomEnterCustom', 26: 'session', 38: 'isAnonymous', _21_safe: '_chatroomAvatar_safe' },
				chatroom: { 1: 'id', 3: 'name', 4: 'announcement', 5: 'broadcastUrl', 12: 'custom', 14: 'createTime', 15: 'updateTime', 16: 'queuelevel', 100: 'creator', 101: 'onlineMemberNum', 102: 'mute' },
				msg: { 1: 'idClient', 2: 'type', 3: 'attach', 4: 'custom', 5: 'resend', 6: 'userUpdateTime', 7: 'fromNick', 8: 'fromAvatar', 9: 'fromCustom', 10: 'yidunEnable', 11: 'antiSpamContent', 12: 'skipHistory', 13: 'body', 14: 'antiSpamBusinessId', 15: 'clientAntiSpam', 16: 'antiSpamUsingYidun', 20: 'time', 21: 'from', 22: 'chatroomId', 23: 'fromClientType', 25: 'highPriority', _8_safe: '_fromAvatar_safe' },
				chatroomMember: { 1: 'chatroomId', 2: 'account', 3: 'type', 4: 'level', 5: 'nick', 6: 'avatar', 7: 'custom', 8: 'online', 9: 'guest', 10: 'enterTime', 12: 'blacked', 13: 'gaged', 14: 'valid', 15: 'updateTime', 16: 'tempMuted', 17: 'tempMuteDuration', _6_safe: '_avatar_safe' }
			};
		},
		function(e, t, n) {
			'use strict';
			e.exports = {
				imLogin: { clientType: 3, os: 4, sdkVersion: 6, appLogin: 8, protocolVersion: 9, pushTokenName: 10, pushToken: 11, deviceId: 13, appKey: 18, account: 19, browser: 24, session: 26, deviceInfo: 32, isReactNative: 112, token: 1e3, customTag: 38 },
				...
				avSignalTag: { type: 1, channelName: 2, channelId: 3, channelCreateTime: 4, channelExpireTime: 5, creator: 6, ext: 7, channelInValid: 8, from: 10, to: 11, requestId: 12, needPush: 13, pushTitle: 14, pushContent: 15, pushPayload: 16, needBadge: 17, members: 18, attach: 19, attachExt: 20, isSave: 21, msgid: 22, uid: 23, time: 24 },
				login: { appKey: 1, account: 2, deviceId: 3, chatroomId: 5, appLogin: 8, chatroomNick: 20, chatroomAvatar: 21, chatroomCustom: 22, chatroomEnterCustom: 23, session: 26, isAnonymous: 38 },
				chatroom: { id: 1, name: 3, announcement: 4, broadcastUrl: 5, custom: 12, createTime: 14, updateTime: 15, queuelevel: 16, creator: 100, onlineMemberNum: 101, mute: 102 },
				msg: { idClient: 1, type: 2, attach: 3, custom: 4, resend: 5, userUpdateTime: 6, fromNick: 7, fromAvatar: 8, fromCustom: 9, yidunEnable: 10, antiSpamContent: 11, skipHistory: 12, body: 13, antiSpamBusinessId: 14, clientAntiSpam: 15, antiSpamUsingYidun: 16, time: 20, from: 21, chatroomId: 22, fromClientType: 23, highPriority: 25 },
				chatroomMember: { chatroomId: 1, account: 2, type: 3, level: 4, nick: 5, avatar: 6, custom: 7, online: 8, guest: 9, enterTime: 10, blacked: 12, gaged: 13, valid: 14, updateTime: 15, tempMuted: 16, tempMuteDuration: 17 }
			};
		},
		function(e, t, n) {
			'use strict';
			var r = n(0),
				s = n(79),
				i = r.merge({}, s.idMap, { chatroom: { id: 13, login: 2, kicked: 3, logout: 4, sendMsg: 6, msg: 7, getChatroomMembers: 8, getHistoryMsgs: 9, markChatroomMember: 11, closeChatroom: 12, getChatroom: 13, updateChatroom: 14, updateMyChatroomMemberInfo: 15, getChatroomMembersInfo: 16, kickChatroomMember: 17, updateChatroomMemberTempMute: 19, queueOffer: 20, queuePoll: 21, queueList: 22, peak: 23, queueDrop: 24, queueInit: 25, queueChange: 26 }, user: { id: 3, syncRobot: 16 } }),
				o = r.merge({}, s.cmdConfig, {
					login: { sid: i.chatroom.id, cid: i.chatroom.login, params: [{ type: 'byte', name: 'type' }, { type: 'Property', name: 'login' }, { type: 'Property', name: 'imLogin' }] },
					...
					getChatroomMembers: { sid: i.chatroom.id, cid: i.chatroom.getChatroomMembers, params: [{ type: 'byte', name: 'type' }, { type: 'long', name: 'time' }, { type: 'int', name: 'limit' }] },
					getHistoryMsgs: { sid: i.chatroom.id, cid: i.chatroom.getHistoryMsgs, params: [{ type: 'long', name: 'timetag' }, { type: 'int', name: 'limit' }, { type: 'bool', name: 'reverse' }, { type: 'LongArray', name: 'msgTypes' }] },
					markChatroomMember: { sid: i.chatroom.id, cid: i.chatroom.markChatroomMember, params: [{ type: 'string', name: 'account' }, { type: 'int', name: 'type' }, { type: 'bool', name: 'isAdd' }, { type: 'int', name: 'level' }, { type: 'string', name: 'custom' }] },
					...
					updateChatroom: { sid: i.chatroom.id, cid: i.chatroom.updateChatroom, params: [{ type: 'Property', name: 'chatroom' }, { type: 'bool', name: 'needNotify' }, { type: 'String', name: 'custom' }] },
					updateMyChatroomMemberInfo: { sid: i.chatroom.id, cid: i.chatroom.updateMyChatroomMemberInfo, params: [{ type: 'Property', name: 'chatroomMember' }, { type: 'bool', name: 'needNotify' }, { type: 'String', name: 'custom' }, { type: 'bool', name: 'needSave' }] },
					getChatroomMembersInfo: { sid: i.chatroom.id, cid: i.chatroom.getChatroomMembersInfo, params: [{ type: 'StrArray', name: 'accounts' }] },
					kickChatroomMember: { sid: i.chatroom.id, cid: i.chatroom.kickChatroomMember, params: [{ type: 'string', name: 'account' }, { type: 'string', name: 'custom' }] },
					updateChatroomMemberTempMute: { sid: i.chatroom.id, cid: i.chatroom.updateChatroomMemberTempMute, params: [{ type: 'String', name: 'account' }, { type: 'long', name: 'duration' }, { type: 'bool', name: 'needNotify' }, { type: 'String', name: 'custom' }] },
					queueOffer: { sid: i.chatroom.id, cid: i.chatroom.queueOffer, params: [{ type: 'string', name: 'elementKey' }, { type: 'string', name: 'elementValue' }, { type: 'bool', name: 'transient' }] },
					...
					queueChange: { sid: i.chatroom.id, cid: i.chatroom.queueChange, params: [{ type: 'StrStrMap', name: 'elementMap' }, { type: 'bool', name: 'needNotify' }, { type: 'string', name: 'notifyExt' }] },
				...
				a = r.merge({}, s.packetConfig, {
					...
					'13_2': { service: 'chatroom', cmd: 'login', response: [{ type: 'Property', name: 'chatroom' }, { type: 'Property', name: 'chatroomMember' }] },
					'13_3': { service: 'chatroom', cmd: 'kicked', response: [{ type: 'Number', name: 'reason' }, { type: 'String', name: 'custom' }] },
					...
					'13_21': { service: 'chatroom', cmd: 'queuePoll', response: [{ type: 'String', name: 'elementKey' }, { type: 'String', name: 'elementValue' }] },
					'13_22': { service: 'chatroom', cmd: 'queueList', response: [{ type: 'KVArray', name: 'queueList' }] },
					'13_23': { service: 'chatroom', cmd: 'peak', response: [{ type: 'String', name: 'elementKey' }, { type: 'String', name: 'elementValue' }] },
		...
		function(e, t, n) {
			...
			e.exports = {
				...
				fileListParam: { 1: 'fromDocId', 2: 'limit' },
				avSignalTag: { 1: 'type', 2: 'channelName', 3: 'channelId', 4: 'channelCreateTime', 5: 'channelExpireTime', 6: 'creator', 7: 'ext', 8: 'channelInValid', 10: 'from', 11: 'to', 12: 'requestId', 13: 'needPush', 14: 'pushTitle', 15: 'pushContent', 16: 'pushPayload', 17: 'needBadge', 18: 'members', 19: 'attach', 20: 'attachExt', 21: 'isSave', 22: 'msgid', 23: 'uid', 24: 'time' },
				login: { 3: 'clientType', 4: 'os', 6: 'sdkVersion', 8: 'appLogin', 9: 'protocolVersion', 10: 'pushTokenName', 11: 'pushToken', 13: 'deviceId', 18: 'appKey', 19: 'account', 24: 'browser', 26: 'session', 32: 'deviceInfo', 38: 'customTag', 112: 'isReactNative', 1000: 'token' },
				...
				sync: { 1: 'myInfo', 2: 'offlineMsgs', 3: 'teams', 6: 'netcallMsgs', 7: 'roamingMsgs', 9: 'relations', 11: 'friends', 12: 'sessions', 13: 'friendUsers', 14: 'msgReceipts', 15: 'myTeamMembers', 16: 'donnop', 17: 'deleteMsg', 18: 'sessionAck', 19: 'robots', 20: 'broadcastMsgs', 21: 'avSignal', 100: 'filterMsgs' },
				donnop: { 1: 'open' },
				team: { 1: 'teamId', 3: 'name', 4: 'type', 5: 'owner', 6: 'level', 7: 'selfCustom', 8: 'valid', 9: 'memberNum', 10: 'memberUpdateTime', 11: 'createTime', 12: 'updateTime', 13: 'validToCurrentUser', 14: 'intro', 15: 'announcement', 16: 'joinMode', 17: 'bits', 18: 'custom', 19: 'serverCustom', 20: 'avatar', 21: 'beInviteMode', 22: 'inviteMode', 23: 'updateTeamMode', 24: 'updateCustomMode', 100: 'mute', 101: 'muteType', _20_safe: '_avatar_safe' },
				teamMember: { 1: 'teamId', 3: 'account', 4: 'type', 5: 'nickInTeam', 7: 'bits', 8: 'active', 9: 'valid', 10: 'joinTime', 11: 'updateTime', 12: 'custom', 13: 'mute' },
				msg: {
					0: 'scene',
					1: 'to',
					2: 'from',
				...
				sysMsg: { 0: 'time', 1: 'type', 2: 'to', 3: 'from', 4: 'ps', 5: 'attach', 6: 'idServer', 7: 'sendToOnlineUsersOnly', 8: 'apnsText', 9: 'pushPayload', 10: 'deletedIdClient', 11: 'deletedIdServer', 12: 'yidunEnable', 13: 'antiSpamContent', 14: 'deletedMsgTime', 15: 'deletedMsgFromNick', 16: 'opeAccount', 105: 'cc', 107: 'isPushable', 109: 'isUnreadable', 110: 'needPushNick' },
				...
				user: { 1: 'account', 3: 'nick', 4: 'avatar', 5: 'sign', 6: 'gender', 7: 'email', 8: 'birth', 9: 'tel', 10: 'custom', 12: 'createTime', 13: 'updateTime', _4_safe: '_avatar_safe' },
				specialRelation: { 0: 'account', 1: 'isMuted', 2: 'isBlacked', 3: 'createTime', 4: 'updateTime' },
				msgType: { 0: 'text', 1: 'picture', 2: 'audio', 3: 'video', 4: 'location', 5: 'notification', 6: 'file', 7: 'netcall_audio', 8: 'netcall_vedio', 9: 'datatunnel_new', 10: 'tips', 11: 'robot', 100: 'custom' },
				msgEvent: { 1: 'type', 2: 'value', 3: 'idClient', 4: 'custom', 5: 'validTime', 6: 'broadcastType', 7: 'sync', 8: 'validTimeType', 9: 'durable', 10: 'time', 11: 'idServer', 12: 'clientType', 13: 'serverConfig', 14: 'serverCustom', 101: 'appid', 103: 'account', 104: 'enableMultiClient', 106: 'consid' },
		...
		function(e, t, n) {
			...
			e.exports = {
				...
				fileListParam: { fromDocId: 1, limit: 2 },
				avSignalTag: { type: 1, channelName: 2, channelId: 3, channelCreateTime: 4, channelExpireTime: 5, creator: 6, ext: 7, channelInValid: 8, from: 10, to: 11, requestId: 12, needPush: 13, pushTitle: 14, pushContent: 15, pushPayload: 16, needBadge: 17, members: 18, attach: 19, attachExt: 20, isSave: 21, msgid: 22, uid: 23, time: 24 },
				login: { clientType: 3, os: 4, sdkVersion: 6, appLogin: 8, protocolVersion: 9, pushTokenName: 10, pushToken: 11, deviceId: 13, appKey: 18, account: 19, browser: 24, session: 26, deviceInfo: 32, isReactNative: 112, token: 1e3, customTag: 38 },
				...
				sync: { myInfo: 1, offlineMsgs: 2, teams: 3, netcallMsgs: 6, roamingMsgs: 7, relations: 9, friends: 11, sessions: 12, friendUsers: 13, msgReceipts: 14, myTeamMembers: 15, donnop: 16, deleteMsg: 17, sessionAck: 18, robots: 19, broadcastMsgs: 20, avSignal: 21, filterMsgs: 100 },
				donnop: { open: 1 },
				team: { teamId: 1, name: 3, type: 4, owner: 5, level: 6, selfCustom: 7, valid: 8, memberNum: 9, memberUpdateTime: 10, createTime: 11, updateTime: 12, validToCurrentUser: 13, intro: 14, announcement: 15, joinMode: 16, bits: 17, custom: 18, serverCustom: 19, avatar: 20, beInviteMode: 21, inviteMode: 22, updateTeamMode: 23, updateCustomMode: 24, mute: 100, muteType: 101 },
				teamMember: { teamId: 1, account: 3, type: 4, nickInTeam: 5, bits: 7, active: 8, valid: 9, joinTime: 10, updateTime: 11, custom: 12, mute: 13 },
				msg: {
					scene: 0,
					to: 1,
					from: 2,
				...
				sysMsg: { time: 0, type: 1, to: 2, from: 3, ps: 4, attach: 5, idServer: 6, sendToOnlineUsersOnly: 7, apnsText: 8, pushPayload: 9, deletedIdClient: 10, deletedIdServer: 11, yidunEnable: 12, antiSpamContent: 13, deletedMsgTime: 14, deletedMsgFromNick: 15, opeAccount: 16, cc: 105, isPushable: 107, isUnreadable: 109, needPushNick: 110 },
				...
				msgType: { text: 0, picture: 1, audio: 2, video: 3, location: 4, notification: 5, file: 6, netcall_audio: 7, netcall_vedio: 8, datatunnel_new: 9, tips: 10, robot: 11, custom: 100 },
				msgEvent: { type: 1, value: 2, idClient: 3, custom: 4, validTime: 5, broadcastType: 6, sync: 7, validTimeType: 8, durable: 9, time: 10, idServer: 11, clientType: 12, serverConfig: 13, serverCustom: 14, appid: 101, account: 103, enableMultiClient: 104, consid: 106 },
		...
		function(e, t, n) {
			...
			(r.onSignalingNotify = function(e) {
				...
				(r.onSignalingMutilClientSyncNotify = function(e) {
					...
					} else this.emitAPI({ type: 'signalingMutilClientSyncNotify', obj: e.content }), s.isFunction(this.options.onSignalingMutilClientSyncNotify) && this.options.onSignalingMutilClientSyncNotify(e.content);
				}),
		...
		function(e, t, n) {
			...
			(a.login = function() {
				...
				(a.assembleIMLogin = function() {
					...
					return (this.sdkSession = this.genSessionKey()), { appLogin: n, appKey: e.appKey, account: t, token: e.token, sdkVersion: d.info.sdkVersion, protocolVersion: d.info.protocolVersion, os: u.os.toString(), browser: u.name + ' ' + u.version, clientType: d.CLIENTTYPE || 16, session: this.sdkSession, deviceId: m.deviceId, isReactNative: d.isRN ? 1 : 0, customTag: e.customTag || '' };
				}),
		...
		function(e, t, n) {
			...
			(r.initConnect = function() {
				...
				(r.resetConnect = function() {
					var e = this.options;
					c.notundef(e.needReconnect) ? (c.verifyParamType('needReconnect', e.needReconnect, 'boolean', 'link::resetConnect'), (this.needReconnect = e.needReconnect)) : (this.needReconnect = !0),
				...
				(r.connectToUrl = function(e) {
					...
					if (((e = e || ''), t.logger.log('link::connectToUrl: ' + e), 'undefined' == typeof window)) {
						var n = c.getGlobal(),
							r = e.split(':');
						n && !n.location && r.length > 1 && (n.location = { protocol: r[0], hostname: r[1].slice(2), port: r[2] }), (this.options.transports = ['websocket']);
					}
				...
				(r.disconnect = function(e) {
					...
					e instanceof Function || (e = function() {}),
						...
						t.socket && t.socket.socket && t.socket.socket.transport
							...
							: n(null),
						t.isConnected() ? (t.logger.log('link::disconnect: start disconnecting'), t.logout()) : t.connecting ? (t.logger.log('link::disconnect: abort connecting'), t.disconnectSocket()) : (t.logger.log('link::disconnect: start otherwise'), (t.connecting = !1), (t.shouldReconnect = !1), (t.needReconnect = !1), t.options.ondisconnect({ callFunc: 'link::disconnect', message: 'manually disconnect status' }));
				}),
				(r.onConnect = function() {
					this.backoff && this.backoff.reset(), (this.reconnectStatus = this.retryCount > 0 ? 1 : 0), (this.retryCount = 0), (this.connecting = !1), (this.initConnecting = !1), (this.shouldReconnect = !0), (this.hasNotifyDisconnected = !1), this.logger.log('link::onConnect: socket onconnected, start login'), this.login(), this.api.reportLogs({ event: 'ws_connected' });
				}),
				...
				(r.notifyDisconnect = function(e) {
					...
					t.hasNotifyDisconnected ||
						...
						t.onWbNotifyHangup instanceof Function && t.onWbNotifyHangup({ content: { account: t.account, channelId: null, timetag: +Date() } }));
				}),
			...
			(o.signalingCreate = function() {
				...
				(o.signalingCreateAndJoin = function(e) {
					...
					return this.signalingCreate(e)
						.catch(function(e) {
							return 10405 === e.code ? (t.logger.warn('api::avSignal:signalingCall room already exists:', e), t.signalingGetChannelInfo({ channelName: n })) : Promise.reject(e);
						})
						.then(function(e) {
				...
				(o.signalingCall = function(e) {
					...
					return this.signalingCreateAndJoin(e).then(function(o) {
						...
						var a = { channelId: (i = o.channelId || i), account: n, requestId: s, offlineEnabled: r, attachExt: e.attachExt || '', pushInfo: e.pushInfo || {} };
				...
				(o.signalingAccept = function(e) {
					...
					return (
						a.verifyOptions(e, 'channelId requestId account', 'api::signalling'),
						this.sendCmdUsePromise('signalingAccept', { avSignalTag: a.merge(e, { to: t, isSave: !0 === n ? 1 : 0 }) })
							.then(function(e) {
								var t = e.avSignalTag;
								return (t.offlineEnabled = 1 === t.isSave), delete t.isSave, Promise.resolve(t);
							})
		...
		function(e, t, n) {
			...
			((a = a || {}).name = a.name || ''),
				...
				(r.reportLogs = function() {
					...
					if (r) {
						var c = o.info;
						e = s.merge(e, { appkey: n.appKey, uid: n.account, os: 'web', session: t.protocol.sdkSession || '', ver: c.sdkVersion, type: t.subType, platform: '' + a.name.toLowerCase() + a.version.replace(/(\.\d+)+$/, '') });
		...
		function(e, t, n) {
			...
			(u.viewImageSync = function(e) {
				...
				function(e) {
					...
					'crop' === e.mode && c.notundef(e.axis) && (c.undef(e.axis.x) && (e.axis.x = 5), c.undef(e.axis.y) && (e.axis.y = 5), c.verifyParamMin('axis.x', e.axis.x, 0, 'nos::viewImageThumbnail'), c.verifyParamMax('axis.x', e.axis.x, 10, 'nos::viewImageThumbnail'), c.verifyParamMin('axis.y', e.axis.y, 0, 'nos::viewImageThumbnail'), c.verifyParamMax('axis.y', e.axis.y, 10, 'nos::viewImageThumbnail'), (r = r + '&axis=' + Math.round(e.axis.x) + '_' + Math.round(e.axis.y))),
		...
		function(e, t, n) {
			...
			(i.transDoc = function(e) {
				...
				try {
					...
					if (['ppt', 'pdf', 'pptx'].indexOf(i) < 0) return void e.done(c.newNoFileError('请上传正确格式的文件【ppt, pptx, pdf】', { callFunc: 'nos: transDoc', fileInput: e.fileInput }), e);
				} catch (t) {
				...
				(i.getNosOriginUrl = function(e) {
					s.verifyOptions(e, 'safeShortUrl', !0, '', 'nos::getNosOriginUrl'), s.verifyParamType('safeShortUrl', e.safeShortUrl, 'string', 'nos::getNosOriginUrl'), /^http(s)?:/.test(e.safeShortUrl) && ~e.safeShortUrl.indexOf('im_url=1') ? (this.processCallback(e), this.sendCmd('getNosOriginUrl', { nosFileUrlTag: { safeUrl: e.safeShortUrl } }, e.callback)) : e.done(new c('参数 “safeShortUrl” 内容非文件安全短链', { callFunc: 'nos: getNosOriginUrl' }), e);
				});
		},
		function(e, t, n) {
			'use strict';
			...
			function l(e) {
				...
				if (u) {
					...
					if (!e.commonUpload) return m > r.chunkMaxSize ? void e.uploaddone(i.newFileTooLargeError('直传文件大小超过' + r.chunkMaxSize + '限制')) : void (t.sn = a(e, n, t));
								...
								return function(t) {
									...
									function a(e, s) {
										...
										return (
											...
											a.hasOwnProperty('#cdata-section') && ((a.__cdata = a['#cdata-section']), delete a['#cdata-section'], 'property' === t.arrayAccessForm && delete a['#cdata-section_asArray']),
									...
									function g(e, n, r) {
										...
										if ((t.jsAttributeConverter && (e = t.jsAttributeConverter.call(null, n, e)), (null != e && '' !== e) || !t.selfClosingElements))
											if ('object' == typeof e)
												...
												else if (e instanceof Date) (s += u(e, n, r, !1)), (s += t.jsDateUTC ? e.toUTCString() : e.toISOString()), (s += l(e, n));
												else {
													var i = d(e);
			...
			(o.sendText = function(e) {
				...
				(o.previewFile = function(e) {
					if (
						...
						e.nosSurvivalTime ? (a.verifyParamType('nosSurvivalTime', e.nosSurvivalTime, 'number', 'api::Base.getInstance'), a.verifyParamMin('nosSurvivalTime', e.nosSurvivalTime, 86400, 'api::Base.getInstance')) : (e.nosSurvivalTime = this.nosSurvivalTime),
						...
						if (((e.fileInput = a.verifyFileInput(e.fileInput, 'msg::previewFile')), e.fileInput.files)) {
							if (!e.fileInput.files.length) return void e.done(u.newNoFileError('请选择' + e.type + '文件', { callFunc: 'msg::previewFile', fileInput: e.fileInput }), e);
				...
				(o._doPreviewFile = function(e) {
					...
					e.commonUpload || !o || l.isWeixinApp || l.isNodejs || l.isRN ? ((e.commonUpload = !0), (t = s)) : (t = o);
					var c = this.assembleUploadParams(e.nosToken);
					function p(t, s, i) {
						if (((e.uploaddone = r), t)) e.done(t, e.callback.options);
						else {
							if (((s = m.parseResponse(s, n.options.exifOrientation)), i || ((s.url = l.genDownloadUrl(e.nosToken, c.Object)), e.nosToken.shortUrl && (s._url_safe = e.nosToken.shortUrl)), a.exist(e.fileInputName))) s.name = e.fileInputName;
							else if (e.blob) {
								var o = e.blob.name;
									...
									success: function(e) {
										if (200 === e.statusCode)
											try {
												...
												console.log('error:', 'parse wx upload file res error', t), p({ code: 'PARSE_WX_UPLOAD_FILE_RES_ERROR', str: e.data, msg: e.errMsg });
											}
							...
							success: function(e) {
								if (200 === e.statusCode)
									try {
										...
										console.log('error:', 'parse nodejs upload file res error', t), p({ code: 'PARSE_NODEJS_UPLOAD_FILE_RES_ERROR', str: e.data, msg: e.errMsg });
									}
								else p({ code: e.statusCode, msg: e.errMsg });
							},
							fail: function(e) {
							...
							success: function(e) {
								if (e.ok && 200 === e.status)
									try {
										...
										console.log('error:', 'parse React Native upload file res error', t), p({ code: 'PARSE_React_Native_UPLOAD_FILE_RES_ERROR', res: e });
									}
				...
				(o.fileQuickTransfer = function(e, t, n) {
					...
					if (a && o >= l.threshold) {
						var u = !0,
							m = { name: i, md5: a, ext: i.slice(i.lastIndexOf('.') + 1), type: c };
						switch (c) {
							case 'image':
						...
						return (
							...
							this.protocol.sendCmd('fileQuickTransfer', d, function(e, s, i) {
								(!e && i && i.fileQuickTransfer && i.fileQuickTransfer.url) || (r.protocol.logger.error('misc::fileQuickTransfer: not found', e, s, i), n()), i && i.fileQuickTransfer && i.fileQuickTransfer.threshold && (l.threshold = i.fileQuickTransfer.threshold || 0), i && i.fileQuickTransfer && i.fileQuickTransfer.url && ((m.size = o || i.fileQuickTransfer.size), (m.url = i.fileQuickTransfer.url), i.fileQuickTransfer._url_safe && (m._url_safe = i.fileQuickTransfer._url_safe), t(e, m, !0));
							})
						);
					}
					n();
				...
				(o.sendFile = function(e) {
					if ((e.type || (e.type = 'file'), a.verifyParamPresentJustOne(e, 'dataURL blob fileInput file filePath wxFilePath fileObject', 'msg::sendFile'), a.exist(e.maxSize) && a.verifyParamType('maxSize', e.maxSize, 'number', 'api::previewFile'), a.exist(e.commonUpload) && a.verifyParamType('commonUpload', e.commonUpload, 'boolean', 'api::previewFile'), this.processCallback(e), (e.filePath = e.filePath || e.wxFilePath), delete e.wxFilePath, e.dataURL)) this._previewAndSendFile(e);
						...
						if (((e.fileInput = a.verifyFileInput(e.fileInput, 'msg::sendFile')), e.fileInput.files && !e.fileInput.files.length)) return void e.done(u.newNoFileError('请选择' + e.type + '文件', { callFunc: 'msg::sendFile', fileInput: e.fileInput }), e.callback.options);
				...
				(o.sendMsg = function(e, t) {
					...
					return (
						t && !this.options.keepNosSafeUrl && o.file && ((o.file._url_safe = o.file.url), (o.file.url = t), 'audio' === o.type && (o.file.mp3Url = t + (~t.indexOf('?') ? '&' : '?') + 'audioTrans&type=mp3')),
						o.hasOwnProperty('chatroomId') && !o.chatroomId
							? a.onError('聊天室未连接')
							: (i && ((o.status = 'success'), (o.isLocal = !0)),
							  ...
							  i || (t && !this.options.keepNosSafeUrl && e.callback && (e.callback.originUrl = t), (s.msg = r), this.sendCmd(e.cmd, s, e.callback)),
							  this.afterSendMsg(e),
							  i &&
									setTimeout(function() {
		...
		function(e, t, n) {
			...
			function i() {
				var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
				s.merge(this, { options: e, debug: !1, api: 'log', style: 'color:blue;', log: s.emptyFunc, info: s.emptyFunc, warn: s.emptyFunc, error: s.emptyFunc }), (this.prefix = e.prefix || ''), this.setDebug(e.debug);
			}
			var o = i.prototype,
		...
		function(e, t, n) {
			...
			(c.updateMyChatroomMemberInfo = function(e) {
				...
				(c.markChatroomIdentity = function(e) {
					i(e, 'identity', 'member::markChatroomIdentity'), (e.type = { manager: 1, common: 2, black: -1, mute: -2 }[e.identity]), delete e.identity, isNaN(e.type) ? i(e, 'identity', 'member::markChatroomIdentity. The valid value of the identity is "manager" or "common" or "black" or "mute".') : this.markChatroomMember(e);
				}),
		...
		function(e, t, n) {
			...
			var r = n(0).notundef,
				s = n(71),
				i = { 301: 'memberEnter', 302: 'memberExit', 303: 'blackMember', 304: 'unblackMember', 305: 'gagMember', 306: 'ungagMember', 307: 'addManager', 308: 'removeManager', 309: 'addCommon', 310: 'removeCommon', 311: 'closeChatroom', 312: 'updateChatroom', 313: 'kickMember', 314: 'addTempMute', 315: 'removeTempMute', 316: 'updateMemberInfo', 317: 'updateQueue', 318: 'muteRoom', 319: 'unmuteRoom', 320: 'batchUpdateQueue' };
			function o() {}
					...
					if (((e.attach = e.attach ? '' + e.attach : ''), e.attach)) {
						...
						if (((t.attach = { type: i[n.id] }), r(n.data))) {
							...
							if (
								...
								'memberEnter' === t.attach.type && (r(o.muted) ? (t.attach.gaged = 1 == +o.muted) : (t.attach.gaged = !1), r(o.tempMuted) ? (t.attach.tempMuted = 1 == +o.tempMuted) : (t.attach.tempMuted = !1), r(o.muteTtl) ? (t.attach.tempMuteDuration = +o.muteTtl) : (t.attach.tempMuteDuration = 0)),
		...
		function(e, t, n) {
			...
			(r.assembleLogin = function() {
				...
				var t = { appKey: e.appKey, account: e.account, deviceId: s.deviceId, chatroomId: e.chatroomId, session: this.sdkSession, appLogin: this.appLogin || 0 };
				return { type: 1, login: (t = i.merge(t, i.filterObj(e, 'chatroomNick chatroomAvatar chatroomCustom chatroomEnterCustom isAnonymous'))), imLogin: this.assembleIMLogin() };
			}),
		...
		function(e, t, n) {
			...
			(o.prototype.assembleEvent = function() {
				return { type: this.type, value: this.value, idClient: this.idClient, custom: this.custom || '', validTime: this.validTime, broadcastType: this.broadcastType, sync: !0 === this.sync ? 1 : 0 };
			}),
				(e.exports = o);
		},
		function(e, t, n) {
		...
		function(e, t, n) {
			...
			(r.markSysMsgRead = function(e) {
				...
				(r.sendCustomSysMsg = function(e) {
					...
					return e.filter && (t = 'sendFilterCustomSysMsg'), this.sendCmd(t, { sysMsg: e.sysMsg, single: !0 }, e.callback), this.formatReturnSysMsg(e.sysMsg);
				}),
			...
			(r.beforeSendMsg = function(e) {
				...
				(r.sendMsgReceipt = function(e) {
					if ((s.verifyOptions(e), this.processCallback(e), e.msg)) {
						...
						var t = e.msg;
						s.verifyOptions(t, 'target idClient time', !0, 'msg.', 'msg::sendMsgReceipt'), this.protocol.shouldSendMsgReceipt(t) ? this.sendCmd('sendMsgReceipt', { msgReceipt: { to: t.target, idClient: t.idClient, time: t.time } }, e.callback) : e.done();
					} else e.done();
				}),
				...
				(r.deleteMsg = function(e) {
					...
					this.processPs(n), this.processCallback(e), o(e.opeAccount) ? (n.opeAccount = e.opeAccount) : i(n.opeAccount) && (n.opeAccount = n.from), 'p2p' === n.scene ? (n.type = 'deleteMsgP2p') : (n.type = 'deleteMsgTeam'), (n.deletedIdClient = n.idClient), (n.deletedIdServer = n.idServer), (n = new u(n)), this.sendCmd('deleteMsg', { sysMsg: n, msg: t }, e.callback);
				});
			...
			(r.getHistoryMsgs = function(e) {
				...
				(r.deleteLocalMsgsBySession = function(e) {
					...
					s.verifyOptions(e, 'scene to', 'msg::deleteLocalMsgsBySession'),
						...
						n.processCallback(e),
						r.enable
							? r.deleteMsgsBySessionId(e).then(function() {
									e.delLastMsg
										? r.updateSession({ id: e.sessionId, lastMsg: null }).then(function(t) {
												n.protocol.onUpdateSession(t), (e.session = t), o();
										  }, i)
										: o();
							  }, i)
							: (e.delLastMsg && n.protocol.onUpdateSession({ id: e.sessionId, lastMsg: null }), o());
				}),
		...
		function(e, t, n) {
			...
			(r.createTeam = function(e) {
				...
				(r.updateTeam = function(e) {
					s.verifyOptions(e, 'teamId', 'team::updateTeam'), (e.action = 'update'), this.processCallback(e), (e.team = new o(e)), this.sendCmd('updateTeam', { team: e.team, single: !0 }, e.callback);
				}),
				...
				(r.updateInfoInTeam = function(e) {
					s.verifyOptions(e, 'teamId', 'team::updateInfoInTeam'), this.processCallback(e), this.sendCmd('updateInfoInTeam', { teamMember: new a(e), single: !0 }, e.callback);
				}),
				(r.updateNickInTeam = function(e) {
					s.verifyOptions(e, 'teamId account', 'team::updateNickInTeam'), this.processCallback(e), this.sendCmd('updateNickInTeam', { teamMember: new a(e), single: !0 }, e.callback);
				}),
				...
				(r.getTeamMembers = function(e) {
					var t = this,
						n = 0;
					s.verifyOptions(e, 'teamId', 'team::getTeamMembers'), t.processCallback(e), t.sendCmd('getTeamMembers', { teamId: e.teamId, timetag: n, NOTSTORE: 'timetag' }, e.callback);
				}),
		...
		function(e, t, n) {
			...
			(r.markInBlacklist = function(e) {
				s.verifyOptions(e, 'account isAdd', 'relation::markInBlacklist'), s.verifyParamType('isAdd', e.isAdd, 'boolean', 'relation::markInBlacklist'), this.processCallback(e), this.sendCmd('markInBlacklist', { account: e.account, isAdd: e.isAdd }, e.callback);
			}),
				...
				(r.markInMutelist = function(e) {
					s.verifyOptions(e, 'account', 'relation::markInMutelist'), s.verifyParamType('isAdd', e.isAdd, 'boolean', 'relation::markInMutelist'), this.processCallback(e), this.sendCmd('markInMutelist', { account: e.account, isAdd: e.isAdd }, e.callback);
				}),
		...
		function(e, t, n) {
			...
			var r = n(0).notundef,
				...
				o = n(119),
				a = n(129),
				c = { 0: 'addTeamMembers', 1: 'removeTeamMembers', 2: 'leaveTeam', 3: 'updateTeam', 4: 'dismissTeam', 5: 'passTeamApply', 6: 'transferTeam', 7: 'addTeamManagers', 8: 'removeTeamManagers', 9: 'acceptTeamInvite', 10: 'updateTeamMute', 101: 'netcallMiss', 102: 'netcallBill' };
			function u() {}
				...
				(r.storeSessionAck = function(e) {
					if (this.options.syncSessionUnread) {
						var t = this.db,
							...
							r = e.timetag;
						if (r <= ((this.findSession(n) || {}).ack || 0)) this.logger.warn('session::storeSessionAck: ack <= ackInMemory', r);
						else {
							var s = { id: n, ack: r };
							this.mergeSession(s), t.enable && t.updateSession(s), this.logger.info('session::storeSessionAck:', s), this.markUnreadBySessionAck({ sessionId: n, ack: s.ack });
						}
					}
				}),
				(r.markUnreadBySessionAck = function(e) {
					...
					if (s.enable)
						r.pushMsgTask(function() {
							return s.getMsgCountAfterAck({ shouldCountNotifyUnread: r.options.shouldCountNotifyUnread, sessionId: t, ack: n }).then(function(e) {
								var n = { id: t, unread: e };
				...
				(r.insertLocalSession = function(e) {
					...
					return new Promise(function(a, c) {
						var u = e.scene,
							...
							m = u + '-' + l,
							d = t.findSession(m);
						if (d) c(o.sessionExist({ callFunc: 'session::insertLocalSession', session: d }));
						else {
							var p;
					...
					return new Promise(function(r, i) {
						...
						if (n.findSession(e.id)) {
							var c = Promise.resolve(),
								u = s.filterObj(e, 'id lastMsg localCustom unread');
		...
		function(e, t, n) {
			...
			(r.onDeleteMsg = function(e) {
				...
				delete e.obj.sysMsg,
					e.error ||
						(e.promise = this.deleteLocalMsg(e.obj.msg).then(function() {
							var n = e.obj.msg;
							t.enable &&
								t.getTimetag('deleteMsg').then(function(e) {
				...
				(r.onDeleteMsgOfflineRoaming = function(e) {
					if (!e.error) {
						...
						(o.cmd = 'deleteMsgSysMsgs ' + n), t.syncPromiseArray.push(o), (t.syncResult.deleteMsgSysMsgs = t.syncResult.deleteMsgSysMsgs || []), t.syncResult.deleteMsgSysMsgs.push({ type: n, sysMsgs: r });
					}
				}),
				...
				(r.deleteLocalMsg = function(e, t) {
					...
					if (r.enable && e) {
						...
						return r
							...
							.then(function() {
								if (n.options.rollbackDelMsgUnread) return r.getSessions({ sessionId: c });
							})
							.then(function(e) {
								var t = { id: c, lastMsg: o },
									r = (e && e.msgReceiptTime) || 0;
								return e && a && r < a.time && n.options.account === a.to && e.unread && (n.logger.log('msgDelete::deleteLocalMsg:db.getSessions: ', e), (t.unread = e.unread - 1)), s(t);
							});
					}
					if (n.options.rollbackDelMsgUnread && e && e.sessionId) {
						var u = n.findSession(e.sessionId),
							l = u.msgReceiptTime || 0;
						u && l < e.time && n.options.account === e.to && u.unread && (n.logger.log('msgDelete::deleteLocalMsg:getSessions: ', u), (u.unread = u.unread - 1), n.onUpdateSession(u));
					}
						...
						? (t = r
								...
								.then(function(t) {
									if ((t = t || u) && n.shouldUpdateSessionFromMsgReceipt(t, e)) {
										...
										return (
											o && o[s] && (o = o[s]).lastMsg && i.lastMsg && o.lastMsg.time > i.lastMsg.time && (i.lastMsg = o.lastMsg),
			...
			(r.processMsg = function(e) {
				...
				(r.onRoamingMsgs = function(e) {
					...
					var l = t
						...
						.then(function(e) {
							(i = e), (i = t.filterIgnore(i)).length && (t.logger.info('msg::onRoamingMsgs: putRoamingMsgs', c, i.length, i), (t.syncResult.roamingMsgs = t.syncResult.roamingMsgs || []), t.syncResult.roamingMsgs.push({ sessionId: c, scene: a.scene, to: a.target, msgs: i, timetag: o }));
						})
						.catch(function(e) {
						...
						if (u.length) {
							...
							n.cacheSyncedSession(o),
								((a = n
									...
									.then(function(s) {
										(u = s), (u = n.filterIgnore(u)).length && (n.logger.info('msg::onOfflineMsgs： toreLastSession', m, e, u.length, u), (n.syncResult[m] = n.syncResult[m] || []), n.syncResult[m].push({ sessionId: e, scene: r, to: i, msgs: u, timetag: t }));
									})
									.catch(function(e) {
				...
				(r.onMsg = function(e, t) {
					...
					t && (n.filter = !0), this.syncing ? (this.logger.log('msg::onMsg:is in syncing ...'), this.unhandledMsgs.push({ type: 'onMsg', msg: n })) : this.handleMsg(n);
				}),
				...
				(r.putMsg = function(e, t) {
					...
					return (
						...
						(a = (a = (a = a
							...
							return e.length && (f((m = n.genSessionByMsgs(e))), o && m)
								? new Promise(function(t, s) {
										r.getSessions({ sessionId: m.id }).then(function(s) {
											...
											n.logger.log('msg::putMsg:db.getSessions: ', m),
												p.length
													? m
														? r.putSession(m).then(function(e) {
																t(e);
														  })
														: t(s)
													: ((d = !0), (p = e), t(s));
						...
						'onMsg' === t
							...
							: 'sendMsg' === t && !l && m && m.lastMsg && m.lastMsg.isLocal && (n.onUpdateSession(m), n.api.resetSessionUnread(n.currSessionId)),
						a.then(function() {
				...
				(r.onSendMsg = function(e, t) {
					...
					if (e.obj) i();
						...
						s &&
							s.enable &&
							s.getMsgByIdClient(r.idClient).then(
								function(e) {
									e && ((r = e), i());
								},
								function(e) {
					...
					function i() {
						...
						(e.error && !s) || ((r.idServer = e.content.msg.idServer), (r.time = +e.content.msg.time)),
				...
				(r.doMarkMsgsRead = function(e, t, n) {
					n &&
						n.length &&
						(!n[0].attach || ('netcallBill' !== n[0].attach.type && 'netcallMiss' !== n[0].attach.type) || ((e = 9), (t = 11)),
			...
			(r.processTeam = function(e) {
				...
				(r.onTeamMembers = function(e) {
					...
					var m = new Promise(function(m, d) {
						e.error
							? s && (r.logger.error('team::onTeamMember: team error:', n, e.error), d({ callFunc: 'team::onTeamMembers', event: e.error, message: 'teamId-' + n + ' 获取群成员错误' }))
							: (!(function() {
									a &&
										o.forEach(function(e) {
							  ...
							  (u.invalid = l),
							  s ? ((r.syncTeamMembersResult[n] = u), (r.syncTeamMembersResult[n + '-invalid'] = l), (r.timetags['team-' + n] = t)) : (r.logger.info('team::onTeamMembers: not syncing, get members', n, i(u), u), (e.obj = { teamId: n, members: u })),
							  m());
					});
				...
				(r.notifyForNewTeamMsg = function(e) {
					...
					return (
						i.length &&
							(o = t.api.getMyTeamMembers({ teamIds: i, promise: !0 }).then(function(e) {
								return (
		...
		function(e, t, n) {
			...
			(r.processUser = function(e) {
						...
						f = new Promise(function(f, h) {
							...
							r
								...
								: (a.forEach(function(e) {
								  ...
								  t.logger.info('user::onRelations: parse blacklist', i(l), l, 'delete', i(m), m),
				...
				(r.markInBlacklist = function(e, t) {
					var n = this.db;
					(e.record = { account: e.account, updateTime: +new Date() }), n.enable && n.markInBlacklist(e), t && (this.logger.info('user::markInBlacklist:', e), this.options.onsyncmarkinblacklist(e));
				}),
				(r.markInMutelist = function(e, t) {
					var n = this.db;
					(e.record = { account: e.account, updateTime: +new Date() }), n.enable && n.markInMutelist(e), t && (this.logger.info('user::markInMutelist:', e), this.options.onsyncmarkinmutelist(e));
				}),
				...
				'Array',
				{
					from: function(e) {
						var t,
							...
							y = 0,
							v = l(d);
						if ((h && (g = r(g, f > 2 ? arguments[2] : void 0, 2)), null == v || (p == Array && a(v)))) for (n = new p((t = c(d.length))); t > y; y++) u(n, y, h ? g(d[y], y) : d[y]);
						else for (m = v.call(d), n = new p(); !(s = m.next()).done; y++) u(n, y, h ? o(m, g, [s.value, y], !0) : s.value);
						return (n.length = y), n;
					}
				}
			);
			...
			(o.beforeSync = function() {
				...
				(o.syncData = function() {
					var e = this,
						...
						r = t.enable;
					function s(t) {
						(e.syncPromiseArray = []), (e.syncResult = {}), (e.syncTeamMembersPromiseArray = []), (e.syncTeamMembersResult = {}), (e.checkNosReqNum = 0), (e.getNosOriginUrlReqNum = 0), a.verifyBooleanWithDefault(n, 'syncRelations syncFriends syncFriendUsers syncTeams syncRoamingMsgs syncMsgReceipts syncExtraTeamInfo', !0, '', 'sync::syncData'), a.verifyBooleanWithDefault(n, 'syncFilter syncTeamMembers', !1, '', 'sync::syncData');
						var r = {};
						(t = t || {}),
				...
				(o.onSyncDone = function(e) {
					...
					if (j && j.length) {
						...
						0 === D.length && D.push(Promise.resolve()),
							Promise.all(D)
								.then(
									function() {
					...
					function L() {
						if (j) {
							if (
								(_.logger.info('sync::onSyncDone: after sync', a.promises2cmds(j)),
								(j = []),
								(n = N.blacklist || []),
								(r = N.invalidBlacklist || []),
								(s = N.mutelist || []),
								(o = N.invalidMutelist || []),
								(f = N.friends),
								(g = N.invalidFriends || []),
								...
								(S = N.roamingMsgs),
								(k = N.offlineMsgs),
								(C = N.offlineFilterMsgs),
								(I = N.offlineSysMsgs),
								(O = N.offlineCustomSysMsgs),
								(x = N.offlineFilterSysMsgs),
								(w = N.offlineFilterCustomSysMsgs),
								N.broadcastMsgs,
								(A = N.sysMsgUnread),
								M)
							) {
									...
									R &&
										...
										(function() {
											...
											U.syncTeams &&
												...
												j.push(t));
											(t = E.getTeamMembersByAccount(_.account)
												.then(function(e) {
					...
					function H() {
						var e,
							t,
							r = [];
						n && (_.logger.info('sync::notifyDataAsync: on blacklist', m(n), n), U.onblacklist(n)),
							s && (_.logger.info('sync::notifyDataAsync: on mutelist', m(s), s), U.onmutelist(s)),
							f && (_.logger.info('sync::notifyDataAsync: on friends', m(f), f), U.onfriends(f)),
							h && (_.logger.info('sync::notifyDataAsync: on myInfo', h), (_.myInfo = h), U.onmyinfo(a.copy(h))),
							y &&
								(y.forEach(function(e) {
									_.mergeUser(e);
								}),
								_.logger.info('sync::notifyDataAsync: on users', m(y), y),
								U.onusers(y)),
							v && (_.logger.info('sync::notifyDataAsync: on teams', d(v), v), U.onteams(v)),
							T && ((!_.hasSynced && M && M.length) || _.hasSynced) && (M = _.mergeSessionAndMsgReceipts(M, T)),
							M &&
								M.length &&
								...
								_.logger.info('sync::notifyDataAsync: on sessions', l(M), M),
								U.onsessions(M)),
							S &&
								S.forEach(function(e) {
									r.push(e.timetag), (t = e.msgs).length && (_.logger.info('sync::notifyDataAsync: on roaming msgs', e.sessionId, t.length, t), U.onroamingmsgs(e));
								}),
							k &&
								k.forEach(function(e) {
									r.push(e.timetag), (t = e.msgs).length && (_.logger.info('sync::notifyDataAsync: on offline msgs', e.sessionId, t.length, t), U.onofflinemsgs(e));
								}),
							C &&
								C.forEach(function(e) {
									r.push(e.timetag), (t = e.msgs).length && (_.logger.info('sync::notifyDataAsync: on offline filter msgs', e.sessionId, t.length, t), U.onofflinefiltermsgs(t));
								});
						var i = [],
							o = [];
						N.deleteMsgSysMsgs &&
							N.deleteMsgSysMsgs.forEach(function(e) {
								'roaming' === e.type ? (i = i.concat(e.sysMsgs)) : (o = o.concat(e.sysMsgs));
							}),
							i.length && (P = (P = P || []).concat(i)),
							o.length && (I = (I = I || []).concat(o)),
							P && (_.logger.info('sync::notifyDataAsync: on roaming sys msgs', P.length, P), U.onroamingsysmsgs(P)),
							I && (_.logger.info('sync::notifyDataAsync: on offline sys msgs', I.length, I), U.onofflinesysmsgs(I)),
							x && (_.logger.info('sync::notifyDataAsync: on offline filter sys msgs', x.length, x), U.onofflinefiltersysmsgs(x)),
							O && (_.logger.info('sync::notifyDataAsync: on offline custom sys msgs', O.length, O), U.onofflinecustomsysmsgs(O)),
							w && (_.logger.info('sync::notifyDataAsync: on offline filter custom sys msgs', w.length, w), U.onofflinefiltercustomsysmsgs(w)),
							A && ((A = a.merge({}, _.sysMsgUnread, A)), (_.sysMsgUnread = a.merge({}, A)), _.logger.info('sync::notifyDataAsync: on sysMsgUnread', A), U.onsysmsgunread(A));
						var c = _.getPushNotificationMultiportConfig();
						_.logger.info('sync::notifyDataAsync: on pushNotificationMultiportConfig', c), U.onPushNotificationMultiportConfig(c), r.length ? ((e = Math.max.apply(Math, r)), _.updateRoamingMsgTimetag(e).then(W, W)) : W(), (_.syncPromiseArray = null), (_.syncResult = null);
					}
					function W() {
						if ((_.processUnsettledMsgs(), _.processUnsettledSysMsgs(), (_.syncing = !1), U.onsyncdone(), U.syncTeamMembers && v && v.length)) throw new c('sync team members api deprecated!');
					}
				}),
					...
					function u() {
						...
						Object.keys(s).forEach(function(i) {
							-1 === i.indexOf('invalid') &&
								...
								(e.invalid = n),
								(function(e, n) {
									t.logger.info('sync::onSyncTeamMembersDone: onTeamMembers', e, m(n), n), r.onteammembers({ teamId: e, members: n });
								})(i, e));
						}),
							l();
					}
		...
		function(e, t, n) {
			...
			r.refreshSocketUrl = function() {
				...
				function a(t) {
					(e.socketUrls = []),
						...
						t.common['link.default'].forEach(function(t) {
							(t = s.formatSocketUrl({ url: t, secure: e.options.secure })), -1 === e.socketUrls.indexOf(t) && e.socketUrls.push(t);
						});
					try {
				...
				function c(t) {
					e.logger.error('link::refreshSocketUrl: ajax lbs error', t), e.api.reportLogs({ event: 'nimlb', code: 3001 }), e.onDisconnect(!1, 'link::refreshSocketUrl');
				}
				(r = r + i.genUrlSep(r) + 'k=' + t.appKey + '&id=' + t.account + '&sv=' + n.sdkVersion + '&pv=' + n.protocolVersion), e.logger.info('link::refreshSocketUrl: ajax ' + r), s.isWeixinApp ? ((r = r.replace(/:\d+/, '')), wx.request({ url: r, success: a, fail: c })) : o(r, { proxyUrl: i.url2origin(r) + '/lbs/res/cors/nej_proxy_frame.html', timeout: s.xhrTimeout, onload: a, onerror: c });
			};
		},
		function(e, t, n) {
			'use strict';
			...
			(r.putSession = function(e) {
				return void 0 === (e = s.merge({}, e)).updateTime && e.lastMsg && e.lastMsg.time && (e.updateTime = e.lastMsg.time), delete e.unread, this.modifyOrPut({ table: 'session', obj: e, key: 'id', modifyObjWhenPut: { unread: 0 } });
			}),
		...
		function(e, t, n) {
			...
			(r.putMsg = function(e) {
				...
				(r.deleteMsgsBySessionId = function(e) {
					return this.getOnly('msg1', 'sessionId', e.sessionId, { remove: !0 });
				}),
		...
		function(e, t, n) {
			...
			var r = { version: 8 },
				s = {
					...
					msg: { key: { autoIncrement: !0 }, indexes: { idClient: { unique: !0 }, sessionId: { unique: !1 }, time: { unique: !1 }, type: { unique: !1 }, sessionType: { unique: !1 }, status: { unique: !1 }, sessionTime: { key: ['sessionId', 'time'], unique: !1 } } },
					msg1: { key: { keyPath: 'idClient' }, indexes: { sessionId: { unique: !1 }, time: { unique: !1 }, status: { unique: !1 }, sessionTime: { key: ['sessionId', 'time'], unique: !1 } } },
					...
					var c,
								...
								c = function(e, t) {
									var n = 'next',
										...
										p = function e() {
											...
											return (
												(t = arguments[0]),
												1 == (c = 'array' === g(t) ? arguments[0] : Array.prototype.slice.call(arguments, 0, 2)).length && c.unshift(0),
												(function(e) {
													return 'number' === g(e);
												})(c[1]) || (c = null),
												{ execute: m, count: d, keys: v, filter: b, asc: M, desc: T, distinct: S, modify: k, limit: e, map: C, remove: P }
											);
										},
										v = function e(t) {
											return (t = !!y(t) || !!t) && (r = 'openKeyCursor'), { execute: m, keys: e, filter: b, asc: M, desc: T, distinct: S, modify: k, limit: p, map: C, remove: P };
										},
										b = function e() {
											return a.push(Array.prototype.slice.call(arguments, 0, 2)), { execute: m, count: d, keys: v, filter: e, asc: M, desc: T, distinct: S, modify: k, limit: p, map: C, remove: P };
										},
										M = function e(t) {
											return (t = !!y(t) || !!t), (n = t ? 'next' : 'prev'), { execute: m, count: d, keys: v, filter: b, asc: e, desc: T, distinct: S, modify: k, limit: p, map: C, remove: P };
										},
										T = function e(t) {
											return (t = !!y(t) || !!t), (n = t ? 'prev' : 'next'), { execute: m, count: d, keys: v, filter: b, asc: M, desc: e, distinct: S, modify: k, limit: p, map: C, remove: P };
										},
										S = function e(t) {
											return (t = !!y(t) || !!t), (l = t), { execute: m, count: d, keys: v, filter: b, asc: M, desc: T, distinct: e, modify: k, limit: p, map: C, remove: P };
										},
										k = function e(t) {
											return (s = t), { execute: m, count: d, keys: v, filter: b, asc: M, desc: T, distinct: S, modify: e, limit: p, map: C, remove: P };
										},
										C = function e(t) {
											return h(t) && (u = t), { execute: m, count: d, keys: v, filter: b, asc: M, desc: T, distinct: S, modify: k, limit: p, map: e, remove: P };
										},
										P = function e(t) {
											return (t = !!y(t) || !!t), (i = t), { execute: m, count: d, keys: v, filter: b, asc: M, desc: T, distinct: S, modify: k, limit: p, map: C, remove: e };
										};
									return { execute: m, count: d, keys: v, filter: b, asc: M, desc: T, distinct: S, modify: k, limit: p, map: C, remove: P };
								};
						...
						S = {
							...
							open: function(e) {
								var t;
								return new Promise(function(n, r) {
									if (T[e.server]) M({ target: { result: T[e.server] } }, e.server, e.version, e.schema).then(n, r);
									else {
										try {
		...
		function(e, t, n) {
			'use strict';
			n(140);
			var r = { NIM: n(449), Chatroom: n(383) };
			n(168)(r), (e.exports = r);
		}
	]);
});
